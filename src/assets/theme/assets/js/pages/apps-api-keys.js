let sparklineConfig = (e, t) => ({
  ...
  dummyActiveUsers = [
    89e3 + 500 * Math.sin(0),
    89200 + 600 * Math.sin(1),
    89700 + 700 * Math.sin(2),
    90500 + 800 * Math.sin(3),
    91e3 + 900 * Math.sin(4),
    91300 + 1e3 * Math.sin(5),
    92e3 + 1100 * Math.sin(6),
  ],
  dummyBlockedUsers = [
    2600 + 10 * Math.sin(0),
    2605 + 12 * Math.sin(1),
  ...
  clipboardElements =
    ...
    document.querySelectorAll("[data-clipboard-target]"));
function generateApiKey(t = 27) {
...
clipboardElements && new ClipboardJS("[data-clipboard-target]");
let inputElement = document.getElementById("apiKeyInput"),
  generateApiKeyBtn = document.getElementById("generateApiKey");
inputElement &&
  generateApiKeyBtn &&
  generateApiKeyBtn.addEventListener("click", (e) => {
    (e.preventDefault(), (inputElement.value = generateApiKey()));
  });
