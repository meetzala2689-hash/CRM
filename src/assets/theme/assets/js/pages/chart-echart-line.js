...
(new CustomEChart({
  ...
  options: () => ({
    ...
    series: [{ data: [150, 180, 120, 190, 110, 170, 130], type: "line" }],
...
let dynamicLineChart = new CustomEChart({
...
(setInterval(function () {
  ...
  dynamicLineChart.chart.setOption({ series: [{ data: data }] });
}, 1e3),
  new CustomEChart({
  ...
  new CustomEChart({
    ...
    options: () => ({
      ...
      yAxis: {
        ...
        axisLabel: { formatter: "{value} km", color: theme("body-color") },
        boundaryGap: !1,
