let hours1 = [
        ...
        series: [
          {
            ...
            data: heatmapData2,
            label: { show: !0, color: "#ffffff" },
            itemStyle: { borderColor: theme("secondary-bg"), borderWidth: 3 },
            emphasis: {
              itemStyle: {
                shadowBlur: 10,
  ...
  xData = [],
  yData = [];
function generateData(t, e, a) {
  var o = [];
  for (let e = 0; e <= 200; e++) {
    for (let t = 0; t <= 100; t++)
      o.push([e, t, noise.perlin2(e / 40, t / 20) + 0.5]);
    xData.push(e);
  }
...
function getNoiseHelper() {
  ...
  function e(a) {
    (0 < a && a < 1 && (a *= 65536),
      (a = Math.floor(a)) < 256 && (a |= a << 8));
    for (let e = 0; e < 256; e++) {
      let t;
      ((t = 1 & e ? r[e] ^ (255 & a) : r[e] ^ ((a >> 8) & 255)),
        (i[e] = i[e + 256] = t),
        (s[e] = s[e + 256] = o[t % 12]));
    }
  }
      ...
      perlin2: function (t, e) {
        var a = Math.floor(t),
          ...
          r =
            ...
            (o &= 255),
            s[a + i[o]].dot2(t, e)),
          l = s[a + i[1 + o]].dot2(t, e - 1),
          h = s[1 + a + i[o]].dot2(t - 1, e),
          a = s[1 + a + i[1 + o]].dot2(t - 1, e - 1),
          o = n(t);
        return d(d(r, h, o), d(l, a, o), n(e));
      },
    }
  );
}
