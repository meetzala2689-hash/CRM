(new CustomApexChart({
  ...
  new CustomApexChart({
    ...
    options: () => ({
      ...
      markers: { size: 4, colors: [theme("chart-alpha")], strokeWidth: 2 },
      tooltip: {
        y: {
...
let updateRadarBtn = document.getElementById("update-radar");
updateRadarBtn && updateRadarBtn.addEventListener("click", update);
