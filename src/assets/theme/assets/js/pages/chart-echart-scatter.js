...
let countries = [
  ...
  generateRandomData = (t) =>
    countries.map((e) => [
      Math.floor(5e4 * Math.random() + 5e3),
      Math.floor(30 * Math.random() + 60),
      Math.floor(1e9 * Math.random() + 5e6),
      e,
      t,
    ]),
  data1 = [generateRandomData(1990), generateRandomData(2015)],
  datasets =
    (new CustomEChart({
        ...
        series: [
          {
            ...
            data: data1[0],
            type: "scatter",
            symbolSize: (e) => Math.sqrt(e[2]) / 500,
            emphasis: {
              focus: "series",
              label: {
                color: theme("tertiary-color"),
                show: !0,
                formatter: (e) => e.data[3],
                position: "top",
              },
            },
            itemStyle: { color: theme("chart-primary", 0.7) },
          },
          {
            name: "2015",
            data: data1[1],
            type: "scatter",
            symbolSize: (e) => Math.sqrt(e[2]) / 700,
            emphasis: {
              focus: "series",
              label: {
                color: theme("body-color"),
            ...
            itemStyle: { color: theme("chart-gamma", 0.7) },
          },
        ],
        grid: { left: 5, right: 10, bottom: 5, top: "15%", containLabel: !0 },
      }),
    }),
    [
      [
