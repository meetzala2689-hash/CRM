(new CustomEChart({
  ...
  options: () => ({
    radar: {
      ...
      name: { textStyle: { color: theme("body-color") } },
      splitArea: {
        show: !0,
        areaStyle: {
          color: [
      ...
      axisLine: { lineStyle: { color: theme("border-color") } },
    },
    legend: {
        ...
        data: [
          {
            ...
            areaStyle: { color: theme("chart-primary-rgb", 0.5) },
            lineStyle: { color: theme("chart-primary-rgb", 0.5) },
            itemStyle: { color: theme("chart-primary") },
          },
          {
            value: [5e3, 14e3, 28e3, 26e3, 42e3, 21e3],
            name: "Actual Spending",
            areaStyle: { color: theme("chart-secondary-rgb", 0.5) },
            lineStyle: { color: theme("chart-secondary-rgb", 0.5) },
  ...
  new CustomEChart({
    ...
    options: () => ({
      ...
      legend: {
        ...
        bottom: 0,
        textStyle: { color: theme("tertiary-color") },
        pageIconColor: theme("tertiary-color"),
        pageTextStyle: { color: theme("tertiary-color") },
        data: (() => {
          var t = [];
          for (let e = 1; e <= 28; e++) t.push(e + 2e3 + "");
          return t;
        })(),
      },
      textStyle: { fontFamily: getComputedStyle(document.body).fontFamily },
      ...
      radar: [
        {
          ...
          splitNumber: 4,
          shape: "circle",
          axisName: { formatter: "【{value}】", color: theme("body-color") },
          splitArea: {
            areaStyle: {
              color: [
                theme("chart-gamma"),
          ...
          axisLine: { lineStyle: { color: "transparent", width: 5 } },
          splitLine: { lineStyle: { color: "transparent", width: 5 } },
        },
        {
          indicator: [
          ...
          center: ["75%", "50%"],
          radius: 120,
          axisName: { color: theme("body-color") },
          splitArea: {
            areaStyle: {
              color: [
                theme("light"),
      ...
      series: [
        {
          ...
          data: [
            { value: [100, 8, 0.4, -80, 2e3], name: "Data A" },
            ...
            },
            {
              ...
              areaStyle: {
                color: new echarts.graphic.RadialGradient(0.1, 0.6, 1, [
                  { color: theme("chart-primary-rgb", 0.1), offset: 0 },
                  { color: theme("chart-primary-rgb", 0.7), offset: 1 },
                ]),
              },
            },
          ],
    ...
    options: () => ({
      ...
      radar: [
        ...
        },
        {
          indicator: (() => {
            var t = [];
            for (let e = 1; e <= 12; e++) t.push({ text: e + "月", max: 100 });
            return t;
          })(),
          center: ["75%", "60%"],
          radius: 80,
