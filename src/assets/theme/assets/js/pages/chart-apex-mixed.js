(new CustomApexChart({
  ...
  options: () => ({
    ...
    legend: { offsetY: 5 },
    grid: { borderColor: [theme("chart-order-color")], padding: { right: 20 } },
  }),
}),
  new CustomApexChart({
    ...
    options: () => ({
      ...
      yaxis: [
        {
          axisTicks: { show: !0 },
          axisBorder: { show: !0, color: theme("chart-primary") },
          title: {
        ...
        {
          axisTicks: { show: !0 },
          axisBorder: { show: !0, color: theme("chart-secondary") },
          labels: { offsetX: 0 },
          offsetX: -5,
          title: {
        ...
        },
        {
          opposite: !0,
          axisTicks: { show: !0 },
          axisBorder: { show: !0, color: theme("chart-alpha") },
          offsetX: 5,
          title: {
