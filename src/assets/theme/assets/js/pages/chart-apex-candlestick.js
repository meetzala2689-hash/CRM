(new CustomApexChart({
  ...
  options: () => ({
    ...
    stroke: { show: !0, colors: [theme("chart-order-color")], width: 1 },
    xaxis: { type: "datetime" },
    ...
    options: () => ({
      ...
      plotOptions: {
        bar: {
          ...
          colors: {
            ranges: [
              { from: -1e3, to: 0, color: theme("chart-alpha") },
              { from: 1, to: 1e4, color: theme("chart-delta") },
            ],
          },
        },
      },
      ...
      yaxis: { labels: { show: !1 } },
      grid: { borderColor: [theme("chart-order-color")] },
    }),
  }),
  new CustomApexChart({
