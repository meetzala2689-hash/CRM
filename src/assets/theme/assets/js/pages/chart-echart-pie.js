    ...
    series: [
      {
        ...
        label: { color: theme("tertiary-color") },
        center: ["50%", "50%"],
        data: [
          {
            value: 1200,
...
let leftChartData = [
    ...
    { value: 735, name: "Basic", itemStyle: { color: theme("chart-primary") } },
    {
      value: 580,
      name: "Optimal",
      itemStyle: { color: theme("chart-secondary") },
    },
    { value: 484, name: "Business", itemStyle: { color: theme("chart-beta") } },
  ...
  rightChartData = [
    ...
    { value: 735, name: "Youtube", itemStyle: { color: theme("chart-gamma") } },
  ...
  data =
    (new CustomEChart({
      ...
      options: () => ({
        ...
        xs: { series: [{ radius: "55%" }, { radius: "55%" }] },
        sm: { series: [{ radius: "65%" }, { radius: "65%" }] },
      }),
    }),
    [
      {
      ...
      { value: 524, name: "Platinum", itemStyle: { color: theme("light") } },
    ]),
  data1 =
    (new CustomEChart({
