let category = [],
  ...
  barData = [];
for (let e = 0; e < 20; e++) {
  let e = new Date((dottedBase += 864e5)),
    t =
      (category.push(
      ...
      200 * Math.random()),
    o = 200 * Math.random();
  (barData.push(t), lineData.push(o + t));
}
new CustomEChart({
  ...
  options: () => ({
    ...
    xAxis: {
      data: category,
      axisLine: { lineStyle: { type: "dashed", color: "#3a3d4e" } },
      axisLabel: { show: !0, color: "#595e7a" },
      splitLine: { lineStyle: { color: "#3a3d4e", type: "dashed" } },
    },
    yAxis: {
      axisLine: { lineStyle: { type: "dashed", color: "#3a3d4e" } },
      axisLabel: { show: !0, color: "#595e7a" },
      splitLine: { show: !1, lineStyle: { color: "#3a3d4e", type: "dashed" } },
    },
      ...
      },
      {
        ...
        itemStyle: {
          ...
          color: new echarts.graphic.LinearGradient(0, 0, 0, 1, [
            ...
            { offset: 1, color: theme("chart-beta") },
          ]),
        },
        data: barData,
      },
...
(new CustomEChart({
  ...
  new CustomEChart({
    ...
    initOptions: { renderer: "canvas", useDirtyRect: !1 },
    options: () => ({
      tooltip: {
        trigger: "item",
      ...
      series: [
        {
          ...
          selectedMode: "single",
          radius: [0, "30%"],
          label: { position: "inner", fontSize: 12, color: "#ffffff" },
          labelLine: { show: !1 },
          data: [
