    ...
    series: [
      {
        ...
        type: "gauge",
        radius: "95%",
        progress: { show: !0, itemStyle: { color: theme("chart-primary") } },
...
let speedStageGaugeChart = new CustomEChart({
  ...
  temperatureGaugeChart =
    (setInterval(() => {
      speedStageGaugeChart.chart.setOption({
        series: [{ data: [{ value: +(100 * Math.random()).toFixed(2) }] }],
      });
    }, 2e3),
    new CustomEChart({
            ...
            return `
                      <div>
                        <h6 class="fs-9 text-body-tertiary mb-0">
                          <span class="fas fa-circle me-1" style='color:${e.color}'></span>
                          ${e.name} : ${e.value}
                        </h6>
                      </div>
                    `;
  ...
  gaugeData =
    (setInterval(function () {
      var e = +(60 * Math.random()).toFixed(2);
      temperatureGaugeChart.chart.setOption({
        series: [{ data: [{ value: e }] }, { data: [{ value: e }] }],
      });
    }, 2e3),
    new CustomEChart({
  ...
  multiGaugeChart = new CustomEChart({
      ...
      series: [
        {
          ...
          axisLine: {
            roundCap: !0,
            lineStyle: { color: [[1, theme("light")]] },
          },
          axisLabel: { color: theme("tertiary-color"), fontSize: 12 },
          data: gaugeData,
          title: { fontSize: 14, color: theme("body-color") },
          detail: {
            width: 30,
            height: 14,
            fontSize: 12,
...
setInterval(function () {
  ((gaugeData[0].value = +(100 * Math.random()).toFixed(2)),
    (gaugeData[1].value = +(100 * Math.random()).toFixed(2)),
    (gaugeData[2].value = +(100 * Math.random()).toFixed(2)),
    multiGaugeChart.chart.setOption({ series: [{ data: gaugeData }] }));
}, 2e3);
