          ...
          <header className="app-topbar">
            <div className="container-fluid topbar-menu">
              ...
              <div className="d-flex align-items-center gap-2">
                <div
                  id="theme-dropdown"
                  className="topbar-item d-none d-sm-flex"
                >
                  <div className="dropdown">
                    <button
                ...
                <div
                  ...
                  className="topbar-item nav-user"
                >
                  <div className="dropdown">
                    <a
                ...
                <ul className="side-nav">
                  ...
                  <li className="side-nav-item">
                    ...
                    >
                      ...
                      <span className="menu-text" data-lang="dashboards">
                        Dashboards
                      </span>
            ...
            <div className="container-fluid">
              <div className="page-title-head d-flex align-items-center">
                <div className="flex-grow-1">
                  <h4 className="page-main-title m-0">Chat</h4>
                </div>
              ...
              <div className="outlook-box gap-1">
                <div
                  className="offcanvas-lg offcanvas-start outlook-left-menu outlook-left-menu-lg"
                  tabindex="-1"
                  id="chatSidebaroffcanvas"
                >
                  <div className="card h-100 mb-0 border-end-0 rounded-end-0">
                    <div className="card-header p-3 border-light card-bg d-block">
                      <div className="d-flex gap-2">
                        ...
                        <a
                          ...
                          data-bs-target="#createSingleChatModal"
                        >
                          <i className="ti ti-pencil fs-xl"></i>
                        </a>
                      </div>
                    </div>
                    <div
                    ...
                    >
                      <div className="list-group list-group-flush chat-list">
                        <a
                          href="#!"
                          data-chat-id="chat1"
                          className="list-group-item list-group-item-action d-flex gap-2 justify-content-between active"
                        >
                          <span className="d-flex justify-content-start align-items-center gap-2 overflow-hidden">
                            ...
                            <span className="overflow-hidden">
                              <span
                                data-chat-search-field
                                className="text-nowrap fw-semibold fs-base mb-0 lh-base"
                              >
                                Ava Thompson
                              </span>
                              <span className="text-muted d-block fs-xs mb-0 text-truncate">
                                I'll send the invoice by evening. Please check
                                and confirm.
                              </span>
                            </span>
                          </span>
                          <span className="d-flex flex-column gap-1 justify-content-center flex-shrink-0 align-items-end">
                            <span className="text-muted fs-xs">Just Now</span>
                            <span className="badge text-bg-primary fs-xxs">
                              2
                            </span>
                          </span>
                        </a>
                        ...
                        >
                          <span className="d-flex justify-content-start align-items-center gap-2 overflow-hidden">
                            ...
                            <span className="overflow-hidden">
                              ...
                              <span className="text-muted d-block fs-xs mb-0 text-truncate">
                                Can you check the shared doc? Added some
                                feedback.
                              </span>
                            </span>
                          </span>
                          <span className="d-flex flex-column gap-1 justify-content-center flex-shrink-0 align-items-end">
                            <span className="text-muted fs-xs">5 Min</span>
                            <span className="badge text-bg-primary fs-xxs">
                              1
                            </span>
                          </span>
                        ...
                        <a
                          href="#!"
                          data-chat-id="chat3"
                          className="list-group-item list-group-item-action d-flex gap-2 justify-content-between"
                        >
                          <span className="d-flex justify-content-start align-items-center gap-2 overflow-hidden">
                            <span className="avatar avatar-sm flex-shrink-0">
                              <img
                            ...
                            <span className="overflow-hidden">
                              ...
                              <span className="text-muted d-block fs-xs mb-0 text-truncate">
                                Please approve the design so we can move to
                                development.
                              </span>
                            </span>
                          </span>
                          <span className="d-flex flex-column gap-1 justify-content-center flex-shrink-0 align-items-end">
                            <span className="text-muted fs-xs">3:45 PM</span>
                          </span>
                        </a>
                        ...
                        >
                          <span className="d-flex justify-content-start align-items-center gap-2 overflow-hidden">
                            ...
                            <span className="overflow-hidden">
                              ...
                              <span className="text-muted d-block fs-xs mb-0 text-truncate">
                                All tasks are completed. Do you want me to
                                deploy?
                              </span>
                            </span>
                          </span>
                          <span className="d-flex flex-column gap-1 justify-content-center flex-shrink-0 align-items-end">
                            <span className="text-muted fs-xs">2 hr</span>
                          </span>
                        </a>
                        ...
                        >
                          <span className="d-flex justify-content-start align-items-center gap-2 overflow-hidden">
                            ...
                            <span className="overflow-hidden">
                              ...
                              <span className="text-muted fs-xs d-block mb-0 text-truncate">
                                Meeting rescheduled to Friday at 11 AM.
                              </span>
                            </span>
                          </span>
                          <span className="d-flex flex-column gap-1 justify-content-center flex-shrink-0 align-items-end">
                            <span className="text-muted fs-xs">4 hr</span>
                          </span>
                        </a>
                        ...
                        >
                          <span className="d-flex justify-content-start align-items-center gap-2 overflow-hidden">
                            <span className="avatar-sm flex-shrink-0">
                              <span className="avatar-title text-bg-secondary fw-bold rounded-circle">
                                WD
                              </span>
                            </span>
                            <span className="overflow-hidden">
                              ...
                              <span className="text-muted d-block fs-xs mb-0 text-truncate">
                                I'm working on the bug fix, will update soon.
                              </span>
                            </span>
                          </span>
                          <span className="d-flex flex-column gap-1 justify-content-center flex-shrink-0 align-items-end">
                            <span className="text-muted fs-xs">Yesterday</span>
                            <span className="badge text-bg-primary fs-xxs">
                              3
                            </span>
                          </span>
                        ...
                        >
                          <span className="d-flex justify-content-start align-items-center gap-2 overflow-hidden">
                            ...
                            <span className="overflow-hidden">
                              ...
                              <span className="text-muted d-block fs-xs mb-0 text-truncate">
                                Final draft is ready. Let me know your thoughts.
                              </span>
                            </span>
                          </span>
                          <span className="d-flex flex-column gap-1 justify-content-center flex-shrink-0 align-items-end">
                        ...
                        >
                          <span className="d-flex justify-content-start align-items-center gap-2 overflow-hidden">
                            ...
                            <span className="overflow-hidden">
                              ...
                              <span className="text-muted d-block fs-xs mb-0 text-truncate">
                                I've uploaded the assets. Please review them
                                tonight.
                              </span>
                            </span>
                          </span>
                          <span className="d-flex flex-column gap-1 justify-content-center flex-shrink-0 align-items-end">
                            <span className="text-muted fs-xs">12 Jun</span>
                          </span>
                        </a>
                        ...
                        >
                          <span className="d-flex justify-content-start align-items-center gap-2 overflow-hidden">
                            ...
                            <span className="overflow-hidden">
                              ...
                              <span className="text-muted d-block fs-xs mb-0 text-truncate">
                                Need your approval before pushing this live.
                              </span>
                            </span>
                          </span>
                          <span className="d-flex flex-column gap-1 justify-content-center flex-shrink-0 align-items-end">
                            <span className="text-muted fs-xs">10 Jun</span>
                          </span>
                        </a>
                        ...
                        >
                          <span className="d-flex justify-content-start align-items-center gap-2 overflow-hidden">
                            <span className="avatar-sm flex-shrink-0">
                              <span className="avatar-title text-bg-info fw-bold rounded-circle">
                                LW
                              </span>
                            </span>
                            <span className="overflow-hidden">
                              ...
                              <span className="text-muted d-block fs-xs mb-0 text-truncate">
                                Client call moved to tomorrow. Will share notes
                                later.
                              </span>
                            </span>
                          </span>
                          <span className="d-flex flex-column gap-1 justify-content-center flex-shrink-0 align-items-end">
                            <span className="text-muted fs-xs">9 May</span>
                          </span>
                        </a>
                        ...
                        >
                          <span className="d-flex justify-content-start align-items-center gap-2 overflow-hidden">
                            ...
                            <span className="overflow-hidden">
                              ...
                              <span className="text-muted d-block fs-xs mb-0 text-truncate">
                                Everything looks good. Waiting for your
                                go-ahead.
                              </span>
                            </span>
                          </span>
                          <span className="d-flex flex-column gap-1 justify-content-center flex-shrink-0 align-items-end">
                            <span className="text-muted fs-xs">13 Apr</span>
                          </span>
                        </a>
                        ...
                        >
                          <span className="d-flex justify-content-start align-items-center gap-2 overflow-hidden">
                            ...
                            <span className="overflow-hidden">
                              ...
                              <span className="text-muted d-block fs-xs mb-0 text-truncate">
                                Checked your updates. Left a few suggestions.
                              </span>
                            </span>
                          </span>
                          <span className="d-flex flex-column gap-1 justify-content-center flex-shrink-0 align-items-end">
                            <span className="text-muted fs-xs">10 Mar</span>
                            <span className="badge text-bg-primary fs-xxs">
                              2
                            </span>
                          </span>
                ...
                <div className="card h-100 mb-0 rounded-start-0 flex-grow-1">
                  <div className="card-header card-bg">
                    ...
                    <div className="flex-grow-1">
                      <h5 className="mb-1 lh-base fs-lg">
                        <a data-chat-username href="#!" className="link-reset">
                          Noah Smith
                        </a>
                      </h5>
                      <p
                      ...
                      >
                        <i className="ti ti-circle-filled text-success"></i>
                        Active
                      </p>
                    </div>
                    ...
                    <div className="d-flex align-items-center gap-1">
                      <button
                        ...
                        title="Video Call"
                      >
                        <i className="ti ti-video fs-lg"></i>
                      </button>
                      <button
                        type="button"
                        className="btn btn-default btn-icon"
                        ...
                        title="Audio Call"
                      >
                        <i className="ti ti-phone-call fs-lg"></i>
                      </button>
                  ...
                  <div
                    ...
                    data-simplebar
                    style="max-height: calc(100vh - 317px)"
                  >
                    <div className="d-flex align-items-start gap-2 my-3 chat-item">
                      ...
                      />
                      <div>
                        <div className="chat-message py-2 px-3 bg-warning-subtle rounded">
                    ...
                    <div className="d-flex align-items-start gap-2 my-3 text-end chat-item justify-content-end">
                      <div>
                        <div className="chat-message py-2 px-3 bg-info-subtle rounded">
                    ...
                    <div className="d-flex align-items-start gap-2 my-3 chat-item">
                      ...
                      <div>
                        <div className="chat-message py-2 px-3 bg-warning-subtle rounded">
                          Just sent them via Drive. Let me know if you have
                          issues accessing.
                        </div>
                        <div className="text-muted fs-xs mt-1">
                          <i className="ti ti-clock"></i>
                  ...
                  <div className="card-footer bg-body-secondary border-top border-dashed border-bottom-0 position-absolute bottom-0 w-100">
                    <div className="d-flex gap-2">
                      <div className="app-search flex-grow-1">
                        <input
                          data-chat-input
                          type="text"
                          className="form-control py-2 bg-light-subtle border-light"
                          placeholder="Enter message..."
                        />
                        <i className="ti ti-message app-search-icon text-muted"></i>
                      </div>
                      <a data-send href="#!" className="btn btn-primary">
                        Send
                        <i className="ti ti-send-2 ms-1 fs-xl"></i>
                      </a>
                    </div>

                    <span data-error className="d-none text-danger mt-2">
                      Hi there!
                    </span>
                  </div>
                </div>
                  ...
                  <div className="modal-content">
                    ...
                    <form id="createSingleChatForm">
                      <div className="modal-body">
                        <div className="mb-3">
                          <label for="recipientUser" className="form-label">
                            Recipient
                          </label>
                          <input
                            type="text"
                        ...
                        <div className="mb-0">
                          <label for="initialMessage" className="form-label">
                            Message
                          </label>
                          <textarea
                            className="form-control"
                ...
                <div className="modal-dialog modal-dialog-centered modal-xl">
                  <div className="modal-content bg-dark text-white">
                    <div className="modal-header border-0">
                      <h5 className="modal-title" id="videoCallModalLabel">
                        Starting Video Call
                      </h5>
                      <button
                        type="button"
                    ...
                    <div className="modal-body d-flex flex-column align-items-center justify-content-center text-center py-5">
                      <div className="mb-4">
                        <img
                          src="assets/images/users/user-3.jpg"
                    ...
                    <div className="modal-footer border-0 justify-content-center">
                      <span className="text-muted fst-italic">
                        Make sure your devices are connected before starting the
                        call
                      </span>
                    </div>
                  </div>
              ...
              <div
                ...
                id="audioCallModal"
                tabindex="-1"
                aria-labelledby="audioCallModalLabel"
                aria-hidden="true"
              >
                <div className="modal-dialog modal-dialog-centered modal-md">
                  <div className="modal-content bg-dark text-white">
                    <div className="modal-header border-0">
                      <h5 className="modal-title" id="audioCallModalLabel">
                        Starting Audio Call
                      </h5>
                      <button
                        type="button"
            ...
            <div id="sidenav-size" className="p-3 border-bottom border-dashed">
              ...
              <div className="row g-3">
                ...
                <div className="col-4" id="sidenav-size-condensed">
                  ...
                  <h5 className="mb-0 text-center text-muted mt-2">
                    Condensed
                  </h5>
                </div>
