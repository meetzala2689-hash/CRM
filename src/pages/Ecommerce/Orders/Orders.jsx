                ...
                <div className="container-fluid">
                    <div className="page-title-head d-flex align-items-center">
                        <div className="flex-grow-1">
                            <h4 className="page-main-title m-0">Orders</h4>
                        </div>
                    ...
                    <div className="row row-cols-xxl-5 row-cols-md-3 row-cols-1 align-items-center g-1">
                            ...
                            <div className="card mb-1">
                                <div className="card-body">
                                    <div className="d-flex align-items-center justify-content-between gap-2 mb-3">
                                        <h3 className="mb-0"><span data-target="93.7">0</span>k</h3>
                        ...
                        <div className="col">
                            <div className="card mb-1">
                                <div className="card-body">
                                    <div className="d-flex align-items-center justify-content-between gap-2 mb-3">
                                        <h3 className="mb-0"><span data-target="557">0</span></h3>
                                        <div className="avatar-md flex-shrink-0">
                                    ...
                                    <p className="mb-0 text-uppercase fs-xs fw-bold">
                                        Pending Orders
                                        <span className="float-end badge badge-soft-danger">-1.12%</span>
                                    </p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="col">
                            <div className="card mb-1">
                                <div className="card-body">
                                    <div className="d-flex align-items-center justify-content-between gap-2 mb-3">
                                        <h3 className="mb-0"><span data-target="269">0</span></h3>
                                        <div className="avatar-md flex-shrink-0">
                        ...
                        <div className="col">
                            <div className="card mb-1">
                                <div className="card-body">
                                    <div className="d-flex align-items-center justify-content-between gap-2 mb-3">
                                        <h3 className="mb-0"><span data-target="9.3">0</span>k</h3>
                                        <div className="avatar-md flex-shrink-0">
                                    ...
                                    <p className="mb-0 text-uppercase fs-xs fw-bold">
                                        New Orders
                                        <span className="float-end badge badge-soft-success">+4.22%</span>
                                    </p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="col">
                            <div className="card mb-1">
                                <div className="card-body">
                                    <div className="d-flex align-items-center justify-content-between gap-2 mb-3">
                                        <h3 className="mb-0"><span data-target="8,741">0</span></h3>
                                        <div className="avatar-md flex-shrink-0">
                                    ...
                                    <p className="mb-0 text-uppercase fs-xs fw-bold">
                                        Returned Orders
                                        <span className="float-end badge badge-soft-success">+0.56%</span>
                                    </p>
                                </div>
                            </div>
                        </div>
                                ...
                                <div className="card-header border-light justify-content-between">
                                    <div className="d-flex gap-2">
                                        <div className="app-search">
                                            <input data-table-search type="search" className="form-control" placeholder="Search order..." />
                                            <i className="ti ti-search app-search-icon text-muted"></i>
                                        </div>
                                    ...
                                    <div className="d-flex align-items-center gap-2">
                                        ...
                                        <div className="app-search">
                                            <select data-table-range-filter="date" className="form-select form-control my-1 my-md-0">
                                    ...
                                    <div className="d-flex gap-1">
                                        <a href="apps-ecommerce-order-add.html" className="btn btn-danger ms-1"> <i className="ti ti-plus fs-sm me-2"></i> Add Order </a>
                                    </div>
                                </div>
                                    ...
                                    <table className="table table-custom table-centered table-select table-hover w-100 mb-0">
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td>
                                                    <h5 className="fs-sm mb-0 fw-medium"><a href="apps-ecommerce-order-details.html" className="link-reset">#WB20100</a></h5>
                                                </td>
                                                <td>9 May, 2025 <small className="text-muted">10:10 AM</small></td>
                                                <td>
                                                ...
                                                <td>$129.45</td>
                                                <td className="text-success fw-semibold"><i className="ti ti-circle-filled fs-sm"></i> Paid</td>
                                                <td><span className="badge badge-soft-success fs-xxs">Delivered</span></td>
                                                <td><img src="assets/images/cards/visa.svg" alt="" className="me-2" height="28" /> xxxx 7832</td>
                                                <td>
                                                    <div className="d-flex justify-content-center gap-1">
                                                        <a href="apps-ecommerce-order-details.html" className="btn btn-default btn-icon btn-sm"><i className="ti ti-eye fs-lg"></i></a>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <h5 className="fs-sm mb-0 fw-medium"><a href="apps-ecommerce-order-details.html" className="link-reset">#WB20101</a></h5>
                                                </td>
                                                <td>7 May, 2025 <small className="text-muted">11:45 AM</small></td>
                                                <td>
                                                    <div className="d-flex justify-content-start align-items-center gap-2">
                                                        <div className="avatar avatar-sm">
                                                        ...
                                                        <div>
                                                            <h5 data-sort="customer" className="text-nowrap fs-base mb-0 lh-base">Ava Martin</h5>
                                                            <p className="text-muted fs-xs mb-0">ava.martin&#64;marketplace.com</p>
                                                        </div>
                                                    </div>
                                                </td>
                                                <td>$87.00</td>
                                                <td className="text-warning fw-semibold">
                                                    <i className="ti ti-circle-filled fs-sm"></i>
                                                    Pending
                                                </td>
                                                <td><span className="badge badge-soft-warning fs-xxs">Processing</span></td>
                                                <td>
                                                    <img src="assets/images/cards/mastercard.svg" alt="" className="me-2" height="28" />
                                                    xxxx 5487
                                                </td>
                                                <td>
                                                    <div className="d-flex justify-content-center gap-1">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <h5 className="fs-sm mb-0 fw-medium"><a href="apps-ecommerce-order-details.html" className="link-reset">#WB20102</a></h5>
                                                </td>
                                                <td>26 Apr, 2025 <small className="text-muted">1:20 PM</small></td>
                                                <td>
                                                    <div className="d-flex justify-content-start align-items-center gap-2">
                                                        <div className="avatar avatar-sm">
                                                        ...
                                                        <div>
                                                            <h5 data-sort="customer" className="text-nowrap fs-base mb-0 lh-base">Noah Wilson</h5>
                                                            <p className="text-muted fs-xs mb-0">noah.wilson&#64;ecomsite.com</p>
                                                        </div>
                                                    </div>
                                                </td>
                                                <td>$59.90</td>
                                                <td className="text-danger fw-semibold"><i className="ti ti-circle-filled fs-sm"></i> Failed</td>
                                                <td><span className="badge badge-soft-danger fs-xxs">Cancelled</span></td>
                                                <td>
                                                    <img src="assets/images/cards/paypal.svg" alt="" className="me-2" height="28" />
                                                    xxx&#64;email.com
                                                </td>
                                                <td>
                                                    <div className="d-flex justify-content-center gap-1">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <h5 className="fs-sm mb-0 fw-medium"><a href="apps-ecommerce-order-details.html" className="link-reset">#WB20103</a></h5>
                                                </td>
                                                <td>27 Apr, 2025 <small className="text-muted">3:30 PM</small></td>
                                                <td>
                                                    <div className="d-flex justify-content-start align-items-center gap-2">
                                                        <div className="avatar avatar-sm">
                                                        ...
                                                        <div>
                                                            <h5 data-sort="customer" className="text-nowrap fs-base mb-0 lh-base">Isabella Moore</h5>
                                                            <p className="text-muted fs-xs mb-0">isabella.moore&#64;onlineshop.com</p>
                                                        </div>
                                                    </div>
                                                </td>
                                                <td>$215.20</td>
                                                <td className="text-success fw-semibold"><i className="ti ti-circle-filled fs-sm"></i> Paid</td>
                                                <td><span className="badge badge-soft-info fs-xxs">Shipped</span></td>
                                                <td><img src="assets/images/cards/stripe.svg" alt="" className="me-2" height="28" /> xxxx 9901</td>
                                                <td>
                                                    <div className="d-flex justify-content-center gap-1">
                                                        <a href="apps-ecommerce-order-details.html" className="btn btn-default btn-icon btn-sm"><i className="ti ti-eye fs-lg"></i></a>
                                                        <a href="#" className="btn btn-default btn-icon btn-sm"><i className="ti ti-edit fs-lg"></i></a>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <h5 className="fs-sm mb-0 fw-medium"><a href="apps-ecommerce-order-details.html" className="link-reset">#WB20104</a></h5>
                                                </td>
                                                <td>28 Apr, 2025 <small className="text-muted">9:55 AM</small></td>
                                                <td>
                                                    <div className="d-flex justify-content-start align-items-center gap-2">
                                                        <div className="avatar avatar-sm">
                                                            <img src="assets/images/users/user-5.jpg" alt="avatar-11" className="img-fluid rounded-circle" />
                                                        </div>
                                                        <div>
                                                            <h5 data-sort="customer" className="text-nowrap fs-base mb-0 lh-base">Lucas Bennett</h5>
                                                            <p className="text-muted fs-xs mb-0">lucas.bennett&#64;shopzone.com</p>
                                                        </div>
                                                    </div>
                                                </td>
                                                <td>$345.75</td>
                                                <td className="text-success fw-semibold"><i className="ti ti-circle-filled fs-sm"></i> Paid</td>
                                                <td><span className="badge badge-soft-success fs-xxs">Delivered</span></td>
                                                <td><img src="assets/images/cards/american-express.svg" alt="" className="me-2" height="28" /> xxxx 4678</td>
                                                <td>
                                                    <div className="d-flex justify-content-center gap-1">
                                                        <a href="apps-ecommerce-order-details.html" className="btn btn-default btn-icon btn-sm"><i className="ti ti-eye fs-lg"></i></a>
                                                        <a href="#" className="btn btn-default btn-icon btn-sm"><i className="ti ti-edit fs-lg"></i></a>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <h5 className="fs-sm mb-0 fw-medium"><a href="apps-ecommerce-order-details.html" className="link-reset">#WB30100</a></h5>
                                                </td>
                                                <td>20 Apr, 2025 <small className="text-muted">2:30 PM</small></td>
                                                <td>
                                                    <div className="d-flex justify-content-start align-items-center gap-2">
                                                        <div className="avatar avatar-sm">
                                                        ...
                                                        <div>
                                                            <h5 data-sort="customer" className="text-nowrap fs-base mb-0 lh-base">Emma Johnson</h5>
                                                            <p className="text-muted fs-xs mb-0">emma.johnson&#64;storemail.com</p>
                                                        </div>
                                                    </div>
                                                </td>
                                                <td>$199.99</td>
                                                <td className="text-success fw-semibold"><i className="ti ti-circle-filled fs-sm"></i> Paid</td>
                                                <td><span className="badge badge-soft-success fs-xxs">Delivered</span></td>
                                                <td><img src="assets/images/cards/discover-card.svg" alt="" className="me-2" height="28" /> xxxx 1234</td>
                                                <td>
                                                    <div className="d-flex justify-content-center gap-1">
                                                        <a href="apps-ecommerce-order-details.html" className="btn btn-default btn-icon btn-sm"><i className="ti ti-eye fs-lg"></i></a>
                                                        <a href="#" className="btn btn-default btn-icon btn-sm"><i className="ti ti-edit fs-lg"></i></a>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <h5 className="fs-sm mb-0 fw-medium"><a href="apps-ecommerce-order-details.html" className="link-reset">#WB30101</a></h5>
                                                </td>
                                                <td>21 Apr, 2025 <small className="text-muted">9:15 AM</small></td>
                                                <td>
                                                    <div className="d-flex justify-content-start align-items-center gap-2">
                                                        <div className="avatar avatar-sm">
                                                        ...
                                                        <div>
                                                            <h5 data-sort="customer" className="text-nowrap fs-base mb-0 lh-base">Liam Thompson</h5>
                                                            <p className="text-muted fs-xs mb-0">liam.thompson&#64;buynow.com</p>
                                                        </div>
                                                    </div>
                                                </td>
                                                <td>$75.50</td>
                                                ...
                                                <td><span className="badge badge-soft-warning fs-xxs">Processing</span></td>
                                                <td>
                                                    <img src="assets/images/cards/unionpay.svg" alt="" className="me-2" height="28" />
                                                    xxxx 9876
                                                </td>
                                                <td>
                                                    <div className="d-flex justify-content-center gap-1">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <h5 className="fs-sm mb-0 fw-medium"><a href="apps-ecommerce-order-details.html" className="link-reset">#WB30102</a></h5>
                                                </td>
                                                <td>22 Apr, 2025 <small className="text-muted">4:45 PM</small></td>
                                                <td>
                                                    <div className="d-flex justify-content-start align-items-center gap-2">
                                                        <div className="avatar avatar-sm">
                                                        ...
                                                        <div>
                                                            <h5 data-sort="customer" className="text-nowrap fs-base mb-0 lh-base">Sophia Davis</h5>
                                                            <p className="text-muted fs-xs mb-0">sophia.davis&#64;shopsite.com</p>
                                                        </div>
                                                    </div>
                                                </td>
                                                <td>$45.25</td>
                                                ...
                                                <td><span className="badge badge-soft-danger fs-xxs">Cancelled</span></td>
                                                <td>
                                                    <img src="assets/images/cards/payoneer.svg" alt="" className="me-2" height="28" />
                                                    xxx&#64;email.com
                                                </td>
                                                <td>
                                                    <div className="d-flex justify-content-center gap-1">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <h5 className="fs-sm mb-0 fw-medium"><a href="apps-ecommerce-order-details.html" className="link-reset">#WB30103</a></h5>
                                                </td>
                                                <td>10 May, 2025 <small className="text-muted">11:00 AM</small></td>
                                                <td>
                                                    <div className="d-flex justify-content-start align-items-center gap-2">
                                                        <div className="avatar avatar-sm">
                                                        ...
                                                        <div>
                                                            <h5 data-sort="customer" className="text-nowrap fs-base mb-0 lh-base">Oliver Brown</h5>
                                                            <p className="text-muted fs-xs mb-0">oliver.brown&#64;webstore.com</p>
                                                        </div>
                                                    </div>
                                                </td>
                                                <td>$299.00</td>
                                                <td className="text-success fw-semibold"><i className="ti ti-circle-filled fs-sm"></i> Paid</td>
                                                <td><span className="badge badge-soft-info fs-xxs">Shipped</span></td>
                                                <td><img src="assets/images/cards/google-wallet.svg" alt="" className="me-2" height="28" /> xxx&#64;google</td>
                                                <td>
                                                    <div className="d-flex justify-content-center gap-1">
                                                        <a href="apps-ecommerce-order-details.html" className="btn btn-default btn-icon btn-sm"><i className="ti ti-eye fs-lg"></i></a>
                                                        <a href="#" className="btn btn-default btn-icon btn-sm"><i className="ti ti-edit fs-lg"></i></a>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <h5 className="fs-sm mb-0 fw-medium"><a href="apps-ecommerce-order-details.html" className="link-reset">#WB30104</a></h5>
                                                </td>
                                                <td>24 Apr, 2025 <small className="text-muted">8:20 AM</small></td>
                                                <td>
                                                    <div className="d-flex justify-content-start align-items-center gap-2">
                                                        <div className="avatar avatar-sm">
                                                        ...
                                                        <div>
                                                            <h5 data-sort="customer" className="text-nowrap fs-base mb-0 lh-base">Charlotte Lee</h5>
                                                            <p className="text-muted fs-xs mb-0">charlotte.lee&#64;marketzone.com</p>
                                                        </div>
                                                    </div>
                                                </td>
                                                <td>$420.80</td>
                                                ...
                                                <td><span className="badge badge-soft-success fs-xxs">Delivered</span></td>
                                                <td>
                                                    <img src="assets/images/cards/bhim.svg" alt="" className="me-2" height="28" />
                                                    xxxx&#64;upi
                                                </td>
                                                <td>
                                                    <div className="d-flex justify-content-center gap-1">
