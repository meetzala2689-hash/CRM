                ...
                <div className="container-fluid">
                    <div className="page-title-head d-flex align-items-center">
                        <div className="flex-grow-1">
                            <h4 className="page-main-title m-0">Sales Reports</h4>
                        </div>
                        ...
                        <div className="text-end">
                            <ol className="breadcrumb m-0 py-0">
                                ...
                                <li className="breadcrumb-item active">Sales Reports</li>
                            </ol>
                        </div>
                    </div>
                        ...
                        <div className="col-xxl-12">
                            <div data-table data-table-rows-per-page="8" className="card">
                                <div className="card-header border-light justify-content-between">
                                    <h5 className="card-title mb-0">Products - 2025</h5>
                                    <div className="d-flex align-items-center gap-2">
                                        <div className="app-search">
                                            <input data-table-search type="search" className="form-control" placeholder="Search reports..." />
                                            <i className="ti ti-search app-search-icon text-muted"></i>
                                        </div>

                                        <div className="app-search">
                                            <input type="text" style="min-width: 250px" className="form-control" id="dateRangePicker" />
                                            <i className="ti ti-calendar app-search-icon text-muted"></i>
                                        </div>

                                        <button type="submit" className="btn btn-secondary"><i className="ti ti-download me-2"></i> Export Report</button>
                                    </div>
                                </div>
                                ...
                                <div className="table-responsive">
                                    <table className="table table-custom table-centered table-select table-hover w-100 mb-0">
                                        ...
                                        <tbody>
                                            <tr>
                                                <td className="ps-3"><input className="form-check-input form-check-input-light fs-14 product-item-check mt-0" type="checkbox" value="option" /></td>
                                                <td>10 July, 2025</td>
                                                <td>68</td>
                                                <td>4</td>
                                                <td>$18.60</td>
...
<script src="assets/js/app.js"></script>
        ...
        <script src="assets/js/pages/ecommerce-sales.js"></script>
    </div>
  )
}
