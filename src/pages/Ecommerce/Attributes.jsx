                ...
                <div className="container-fluid">
                    <div className="page-title-head d-flex align-items-center">
                        <div className="flex-grow-1">
                            <h4 className="page-main-title m-0">Attributes</h4>
                        </div>
                                ...
                                <div className="card-header border-light justify-content-between">
                                    <div className="d-flex gap-2">
                                        <div className="app-search">
                                            <input data-table-search type="search" className="form-control" placeholder="Search attributes..." />
                                            <i className="ti ti-search app-search-icon text-muted"></i>
                                        </div>
                                    ...
                                    <div className="d-flex align-items-center gap-2 flex-wrap">
                                        ...
                                        <div className="app-search">
                                            <select data-table-filter="attri-type" className="form-select form-control my-1 my-md-0">
                                                <option value="All">Type</option>
                                                <option value="Dropdown">Dropdown</option>
                                                <option value="Text">Text</option>
                                                <option value="Number">Number</option>
                                            </select>
                                            <i className="ti ti-wand app-search-icon text-muted"></i>
                                        </div>
                                    ...
                                    <div className="d-flex gap-1">
                                        <a href="#addAttributeModal" className="btn btn-danger ms-1" data-bs-toggle="modal">
                                ...
                                <div className="table-responsive">
                                    <table className="table table-custom table-centered table-select table-hover w-100 mb-0">
                                        <thead className="bg-light align-middle bg-opacity-25 thead-sm">
                                            <tr className="text-uppercase fs-xxs">
                                                <th className="ps-3" style="width: 1%">
                                                    <input data-table-select-all className="form-check-input form-check-input-light fs-14 mt-0" type="checkbox" id="select-all-attributes" />
                                                </th>
                                        ...
                                        <tbody>
                                            <tr>
                                                <td className="ps-3">
                                                    <input className="form-check-input form-check-input-light fs-14 mt-0" type="checkbox" />
                                                </td>
                                                <td><h6 className="mb-0 fw-medium fs-base">Color</h6></td>
                                                <td>Dropdown</td>
                                                <td><span className="text-muted">Red, Blue, Green, Black</span></td>
                                                <td>
                                                    <div className="form-check form-switch">
                                                        <input className="form-check-input" type="checkbox" checked />
                                                    </div>
                                                </td>
                                                <td>04 Oct, 2025 <small className="text-muted">10:00 AM</small></td>
                                                <td>09 Oct, 2025 <small className="text-muted">11:30 AM</small></td>
                                                <td>
                                                    <div className="d-flex align-items-center gap-2">
                                                        ...
                                                        <div>
                                                            ...
                                                            <p className="text-muted fs-xs mb-0">Admin</p>
                                                        </div>
                                                    </div>
                                                </td>
                                                <td>
                                            ...
                                            <tr>
                                                ...
                                                <td><h6 className="mb-0 fw-medium fs-base">Size</h6></td>
                                                <td>Dropdown</td>
                                                <td><span className="text-muted">S, M, L, XL</span></td>
                                                <td>
                                                    <div className="form-check form-switch">
                                                        <input className="form-check-input" type="checkbox" checked />
                                                    </div>
                                                </td>
                                                <td>03 Oct, 2025 <small className="text-muted">01:20 PM</small></td>
                                                <td>08 Oct, 2025 <small className="text-muted">10:45 AM</small></td>
                                                <td>
                                                    <div className="d-flex align-items-center gap-2">
                                                        <div className="avatar avatar-sm">
                                                        ...
                                                        <div>
                                                            <h6 className="mb-0 fw-semibold">Emma Johnson</h6>
                                                            <p className="text-muted fs-xs mb-0">Manager</p>
                                                        </div>
                                                    </div>
                                                </td>
                                                <td>
                                            ...
                                            <tr>
                                                ...
                                                <td><h6 className="mb-0 fw-medium fs-base">Material</h6></td>
                                                <td>Text</td>
                                                <td><span className="text-muted">Cotton, Leather, Metal</span></td>
                                                <td>
                                                    <div className="form-check form-switch">
                                                        <input className="form-check-input" type="checkbox" />
                                                    </div>
                                                </td>
                                                <td>02 Oct, 2025 <small className="text-muted">04:40 PM</small></td>
                                                <td>06 Oct, 2025 <small className="text-muted">04:10 PM</small></td>
                                                <td>
                                                    <div className="d-flex align-items-center gap-2">
                                                        <div className="avatar avatar-sm">
                                                        ...
                                                        <div>
                                                            <h6 className="mb-0 fw-semibold">Sophia Turner</h6>
                                                            <p className="text-muted fs-xs mb-0">Editor</p>
                                                        </div>
                                                    </div>
                                                </td>
                                                <td>
                                            ...
                                            <tr>
                                                ...
                                                <td><h6 className="mb-0 fw-medium fs-base">Brand</h6></td>
                                                <td>Dropdown</td>
                                                <td><span className="text-muted">Nike, Apple, Samsung</span></td>
                                                <td>
                                                    <div className="form-check form-switch">
                                                        <input className="form-check-input" type="checkbox" checked />
                                                    </div>
                                                </td>
                                                <td>01 Oct, 2025 <small className="text-muted">11:05 AM</small></td>
                                                <td>05 Oct, 2025 <small className="text-muted">01:25 PM</small></td>
                                                <td>
                                                    <div className="d-flex align-items-center gap-2">
                                                        <div className="avatar avatar-sm">
                                                        ...
                                                        <div>
                                                            <h6 className="mb-0 fw-semibold">Oliver Hayes</h6>
                                                            <p className="text-muted fs-xs mb-0">Moderator</p>
                                                        </div>
                                                    </div>
                                                </td>
                                                <td>
                                            ...
                                            <tr>
                                                ...
                                                <td><h6 className="mb-0 fw-medium fs-base">Warranty</h6></td>
                                                <td>Number</td>
                                                <td><span className="text-muted">6 Months, 1 Year, 2 Years</span></td>
                                                <td>
                                                    <div className="form-check form-switch">
                                                        <input className="form-check-input" type="checkbox" checked />
                                                    </div>
                                                </td>
                                                <td>03 Oct, 2025 <small className="text-muted">08:50 AM</small></td>
                                                <td>07 Oct, 2025 <small className="text-muted">09:10 AM</small></td>
                                                <td>
                                                    <div className="d-flex align-items-center gap-2">
                                                        <div className="avatar avatar-sm">
                                                        ...
                                                        <div>
                                                            <h6 className="mb-0 fw-semibold">Ava Mitchell</h6>
                                                            <p className="text-muted fs-xs mb-0">Admin</p>
                                                        </div>
                                                    </div>
                                                </td>
                                            ...
                                            <tr>
                                                ...
                                                <td><h6 className="mb-0 fw-medium fs-base">Weight</h6></td>
                                                <td>Number</td>
                                                <td><span className="text-muted">500g, 1kg, 2kg, 5kg</span></td>
                                                <td>
                                                    <div className="form-check form-switch">
                                                        <input className="form-check-input" type="checkbox" checked />
                                                    </div>
                                                </td>
                                                <td>05 Oct, 2025 <small className="text-muted">09:00 AM</small></td>
                                                <td>09 Oct, 2025 <small className="text-muted">01:15 PM</small></td>
                                                <td>
                                                    <div className="d-flex align-items-center gap-2">
                                                        <div className="avatar avatar-sm">
                                                        ...
                                                        <div>
                                                            <h6 className="mb-0 fw-semibold">Noah Carter</h6>
                                                            <p className="text-muted fs-xs mb-0">Editor</p>
                                                        </div>
                                                    </div>
                                                </td>
                                            ...
                                            <tr>
                                                ...
                                                <td><h6 className="mb-0 fw-medium fs-base">Fabric Type</h6></td>
                                                <td>Text</td>
                                                <td><span className="text-muted">Cotton, Silk, Linen, Polyester</span></td>
                                                <td>
                                                    <div className="form-check form-switch">
                                                        <input className="form-check-input" type="checkbox" checked />
                                                    </div>
                                                </td>
                                                <td>04 Oct, 2025 <small className="text-muted">02:30 PM</small></td>
                                                <td>08 Oct, 2025 <small className="text-muted">03:10 PM</small></td>
                                                <td>
                                                    <div className="d-flex align-items-center gap-2">
                                                        <div className="avatar avatar-sm">
                                                        ...
                                                        <div>
                                                            <h6 className="mb-0 fw-semibold">Chloe Anderson</h6>
                                                            <p className="text-muted fs-xs mb-0">Designer</p>
                                                        </div>
                                                    </div>
                                                </td>
                                                <td>
                                            ...
                                            <tr>
                                                ...
                                                <td><h6 className="mb-0 fw-medium fs-base">Voltage</h6></td>
                                                <td>Number</td>
                                                <td><span className="text-muted">110V, 220V, 240V</span></td>
                                                <td>
                                                    <div className="form-check form-switch">
                                                        <input className="form-check-input" type="checkbox" checked />
                                                    </div>
                                                </td>
                                                <td>01 Oct, 2025 <small className="text-muted">10:20 AM</small></td>
                                                <td>07 Oct, 2025 <small className="text-muted">09:30 AM</small></td>
                                                <td>
                                                    <div className="d-flex align-items-center gap-2">
                                                        <div className="avatar avatar-sm">
                                                        ...
                                                        <div>
                                                            <h6 className="mb-0 fw-semibold">Lucas Rivera</h6>
                                                            <p className="text-muted fs-xs mb-0">Technician</p>
                                                        </div>
                                                    </div>
                                                </td>
                                                <td>
                                            ...
                                            <tr>
                                                ...
                                                <td><h6 className="mb-0 fw-medium fs-base">Capacity</h6></td>
                                                <td>Dropdown</td>
                                                <td><span className="text-muted">250ml, 500ml, 1L, 2L</span></td>
                                                <td>
                                                    <div className="form-check form-switch">
                                                        <input className="form-check-input" type="checkbox" />
                                                    </div>
                                                </td>
                                                <td>03 Oct, 2025 <small className="text-muted">09:40 AM</small></td>
                                                <td>08 Oct, 2025 <small className="text-muted">05:20 PM</small></td>
                                                <td>
                                                    <div className="d-flex align-items-center gap-2">
                                                        <div className="avatar avatar-sm">
                                                        ...
                                                        <div>
                                                            <h6 className="mb-0 fw-semibold">Amelia Scott</h6>
                                                            <p className="text-muted fs-xs mb-0">Supervisor</p>
                                                        </div>
                                                    </div>
                                                </td>
                                                <td>
                                            ...
                                            <tr>
                                                ...
                                                <td><h6 className="mb-0 fw-medium fs-base">Origin</h6></td>
                                                <td>Dropdown</td>
                                                <td><span className="text-muted">USA, Germany, China, Japan</span></td>
                                                <td>
                                                    <div className="form-check form-switch">
                                                        <input className="form-check-input" type="checkbox" checked />
                                                    </div>
                                                </td>
                                                <td>02 Oct, 2025 <small className="text-muted">03:15 PM</small></td>
                                                <td>09 Oct, 2025 <small className="text-muted">06:45 PM</small></td>
                                                <td>
                                                    <div className="d-flex align-items-center gap-2">
                                                        <div className="avatar avatar-sm">
                                                        ...
                                                        <div>
                                                            <h6 className="mb-0 fw-semibold">Ethan Brooks</h6>
                                                            <p className="text-muted fs-xs mb-0">Admin</p>
                                                        </div>
                                                    </div>
                                                </td>
                    ...
                    <div className="modal fade" id="addAttributeModal" tabindex="-1" aria-labelledby="addAttributeModalLabel" aria-hidden="true">
                        <div className="modal-dialog modal-dialog-centered modal-lg">
                            <div className="modal-content border-light rounded-3 shadow-sm">
                                <div className="modal-header">
                                    <h5 className="modal-title fw-semibold" id="addAttributeModalLabel"><i className="ti ti-circle-dashed-plus me-2"></i> Add New Attribute</h5>
                                ...
                                <form id="addAttributeForm">
                                    <div className="modal-body">
                                        <div className="row g-3">
                                            <div className="col-md-6">
                                                <label for="attributeName" className="form-label fw-semibold">Attribute Name</label>
                                                <input type="text" id="attributeName" className="form-control" placeholder="e.g. Color, Size, Material" required />
                                            </div>

                                            <div className="col-md-6">
                                                <label for="attributeType" className="form-label fw-semibold">Type</label>
                                                <select id="attributeType" className="form-select" required>
                                            ...
                                            <div className="col-12">
                                                <label for="attributeValues" className="form-label fw-semibold">Values</label>
                                                <textarea id="attributeValues" className="form-control" rows="2" placeholder="Separate multiple values with commas (e.g. Red, Blue, Green)"></textarea>
                                                <small className="text-muted d-block mt-1">Applicable only for Dropdown or selectable attributes.</small>
                                            </div>

                                            <div className="col-12">
                                                <div className="form-check form-switch">
                                                    <input className="form-check-input" type="checkbox" id="attributeStatus" checked />
                                                    <label className="form-check-label fw-semibold" for="attributeStatus">Active</label>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div className="modal-footer">
                                        ...
                                        <button type="submit" className="btn btn-danger"><i className="ti ti-device-floppy me-1"></i> Save Attribute</button>
                                    </div>
                                </form>
                            </div>
                        </div>
