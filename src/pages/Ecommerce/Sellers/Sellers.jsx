                ...
                <div className="container-fluid">
                    <div className="page-title-head d-flex align-items-center">
                        <div className="flex-grow-1">
                            <h4 className="page-main-title m-0">Sellers</h4>
                        </div>
                                ...
                                <div className="card-header border-light justify-content-between">
                                    <div className="d-flex gap-2">
                                        <div className="app-search">
                                            <input data-table-search type="search" className="form-control" placeholder="Search seller..." />
                                            <i className="ti ti-search app-search-icon text-muted"></i>
                                        </div>
                                    ...
                                    <div className="d-flex align-items-center gap-2">
                                        ...
                                        <div className="app-search">
                                            <select data-table-range-filter="orders" className="form-select form-control my-1 my-md-0">
                                                <option value="All">Orders</option>
                                                <option value="20000+">Top Orders</option>
                                                <option value="0-20000">Low Orders</option>
                                                <option value="0">No Orders</option>
                                            </select>
                                            <i className="ti ti-shopping-cart app-search-icon text-muted"></i>
                                        </div>

                                        <div className="app-search">
                                            <select data-table-range-filter="revenue" className="form-select form-control my-1 my-md-0">
                                        ...
                                        <div className="app-search">
                                            <select data-table-range-filter="rating" className="form-select form-control my-1 my-md-0">
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td>
                                                    <div className="d-flex align-items-center">
                                                        <div className="avatar-md me-3">
                                                            <img src="assets/images/sellers/3.png" alt="Product" className="img-fluid rounded" />
                                                        </div>
                                                        <div>
                                                            <h5 className="mb-1">
                                                                <a data-sort="seller" href="apps-ecommerce-seller-details.html" className="link-reset">GreenTech Solutions</a>
                                                            </h5>
                                                            <p className="text-muted mb-0 fs-xxs">Since 2005</p>
                                                        </div>
                                                    </div>
                                                </td>
                                                <td>1,456</td>
                                                ...
                                                <td>
                                                    ...
                                                    <span className="ms-1"><a data-sort="rating" href="apps-ecommerce-reviews.html" className="link-reset fw-semibold">(4.5)</a></span>
                                                </td>
                                                <td>
                                                    <span className="badge p-1 text-bg-light fs-sm"> <img src="assets/images/flags/ca.svg" alt="" className="rounded-circle me-1" height="12" /> CA </span>
                                                </td>
                                                <td>$92.5k</td>
                                                <td>1st</td>
                                                <td>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div className="d-flex align-items-center">
                                                        <div className="avatar-md me-3">
                                                            <img src="assets/images/sellers/4.png" alt="Product" className="img-fluid rounded" />
                                                        </div>
                                                        <div>
                                                            <h5 className="mb-1">
                                                                <a data-sort="seller" href="apps-ecommerce-seller-details.html" className="link-reset">TechTonic Store</a>
                                                            </h5>
                                                            <p className="text-muted mb-0 fs-xxs">Since 2010</p>
                                                        </div>
                                                    </div>
                                                </td>
                                                <td>2,378</td>
                                                ...
                                                <td>
                                                    ...
                                                    <span className="ms-1"><a data-sort="rating" href="apps-ecommerce-reviews.html" className="link-reset fw-semibold">(3)</a></span>
                                                </td>
                                                <td>
                                                    <span className="badge p-1 text-bg-light fs-sm"> <img src="assets/images/flags/gb.svg" alt="" className="rounded-circle me-1" height="12" /> UK </span>
                                                </td>
                                                <td>$145.7k</td>
                                                <td>2nd</td>
                                                <td>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div className="d-flex align-items-center">
                                                        <div className="avatar-md me-3">
                                                            <img src="assets/images/sellers/5.png" alt="Product" className="img-fluid rounded" />
                                                        </div>
                                                        <div>
                                                            <h5 className="mb-1">
                                                                <a data-sort="seller" href="apps-ecommerce-seller-details.html" className="link-reset">UrbanTech Gadgets</a>
                                                            </h5>
                                                            <p className="text-muted mb-0 fs-xxs">Since 2012</p>
                                                        </div>
                                                    </div>
                                                </td>
                                                <td>3,120</td>
                                                ...
                                                <td>
                                                    ...
                                                    <span className="ms-1"><a data-sort="rating" href="apps-ecommerce-reviews.html" className="link-reset fw-semibold">(3.5)</a></span>
                                                </td>
                                                <td>
                                                    <span className="badge p-1 text-bg-light fs-sm"> <img src="assets/images/flags/in.svg" alt="" className="rounded-circle me-1" height="12" /> IN </span>
                                                </td>
                                                <td>$300.4k</td>
                                                <td>3rd</td>
                                                <td>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div className="d-flex align-items-center">
                                                        <div className="avatar-md me-3">
                                                            <img src="assets/images/sellers/6.png" alt="Product" className="img-fluid rounded" />
                                                        </div>
                                                        <div>
                                                            <h5 className="mb-1">
                                                                <a data-sort="seller" href="apps-ecommerce-seller-details.html" className="link-reset">NextGen Electronics</a>
                                                            </h5>
                                                ...
                                                <td>
                                                    ...
                                                    <span className="ms-1"><a data-sort="rating" href="apps-ecommerce-reviews.html" className="link-reset fw-semibold">(2)</a></span>
                                                </td>
                                                <td>
                                                    <span className="badge p-1 text-bg-light fs-sm"> <img src="assets/images/flags/fr.svg" alt="" className="rounded-circle me-1" height="12" /> FR </span>
                                                </td>
                                                <td>$78.9k</td>
                                                <td>4th</td>
                                                <td>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div className="d-flex align-items-center">
                                                        <div className="avatar-md me-3">
                                                            <img src="assets/images/sellers/7.png" alt="Product" className="img-fluid rounded" />
                                                        </div>
                                                        <div>
                                                            <h5 className="mb-1">
                                                                <a data-sort="seller" href="apps-ecommerce-seller-details.html" className="link-reset">SmartHome Goods</a>
                                                            </h5>
                                                            <p className="text-muted mb-0 fs-xxs">Since 2015</p>
                                                        </div>
                                                    </div>
                                                </td>
                                                <td>520</td>
                                                ...
                                                <td>
                                                    <span className="badge p-1 text-bg-light fs-sm"> <img src="assets/images/flags/de.svg" alt="" className="rounded-circle me-1" height="12" /> DE </span>
                                                </td>
                                                <td>$56.2k</td>
                                                <td>5th</td>
                                                <td>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div className="d-flex align-items-center">
                                                        <div className="avatar-md me-3">
                                                            <img src="assets/images/sellers/8.png" alt="Product" className="img-fluid rounded" />
                                                        </div>
                                                        <div>
                                                            <h5 className="mb-1">
                                                                <a data-sort="seller" href="apps-ecommerce-seller-details.html" className="link-reset">TechMasters</a>
                                                            </h5>
                                                            <p className="text-muted mb-0 fs-xxs">Since 2013</p>
                                                        </div>
                                                    </div>
                                                </td>
                                                <td>2,160</td>
                                                ...
                                                <td>
                                                    ...
                                                    <span className="ms-1"><a data-sort="rating" href="apps-ecommerce-reviews.html" className="link-reset fw-semibold">(5)</a></span>
                                                </td>
                                                <td>
                                                    <span className="badge p-1 text-bg-light fs-sm"> <img src="assets/images/flags/us.svg" alt="" className="rounded-circle me-1" height="12" /> US </span>
                                                </td>
                                                <td>$600k</td>
                                                <td>6th</td>
                                                <td>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div className="d-flex align-items-center">
                                                        <div className="avatar-md me-3">
                                                            <img src="assets/images/sellers/9.png" alt="Product" className="img-fluid rounded" />
                                                        </div>
                                                        <div>
                                                            <h5 className="mb-1">
                                                                <a data-sort="seller" href="apps-ecommerce-seller-details.html" className="link-reset">FutureGizmos</a>
                                                            </h5>
                                                ...
                                                <td>
                                                    <span className="badge p-1 text-bg-light fs-sm"> <img src="assets/images/flags/it.svg" alt="" className="rounded-circle me-1" height="12" /> IT </span>
                                                </td>
                                                <td>$170.2k</td>
                                                <td>7th</td>
                                                <td>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div className="d-flex align-items-center">
                                                        <div className="avatar-md me-3">
                                                            <img src="assets/images/sellers/10.png" alt="Product" className="img-fluid rounded" />
                                                        </div>
                                                        <div>
                                                            <h5 className="mb-1">
                                                                <a data-sort="seller" href="apps-ecommerce-seller-details.html" className="link-reset">GizmoX</a>
                                                            </h5>
                                                ...
                                                <td>
                                                    <span className="badge p-1 text-bg-light fs-sm"> <img src="assets/images/flags/au.svg" alt="" className="rounded-circle me-1" height="12" /> AU </span>
                                                </td>
                                                <td>$210.3k</td>
                                                <td>8th</td>
                                                <td>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div className="d-flex align-items-center">
                                                        <div className="avatar-md me-3">
                                                            <img src="assets/images/sellers/1.png" alt="Product" className="img-fluid rounded" />
                                                        </div>
                                                        <div>
                                                            <h5 className="mb-1">
                                                                <a data-sort="seller" href="apps-ecommerce-seller-details.html" className="link-reset">NextWave Electronics</a>
                                                            </h5>
                                                ...
                                                <td>
                                                    <span className="badge p-1 text-bg-light fs-sm"> <img src="assets/images/flags/br.svg" alt="" className="rounded-circle me-1" height="12" /> BR </span>
                                                </td>
                                                <td>$125.4k</td>
                                                <td>9th</td>
                                                <td>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div className="d-flex align-items-center">
                                                        <div className="avatar-md me-3">
                                                            <img src="assets/images/sellers/2.png" alt="Product" className="img-fluid rounded" />
                                                        </div>
                                                        <div>
                                                            <h5 className="mb-1">
                                                                <a data-sort="seller" href="apps-ecommerce-seller-details.html" className="link-reset">FutureTech Innovations</a>
                                                            </h5>
                                                ...
                                                <td>
                                                    ...
                                                    <span className="ms-1"><a data-sort="rating" href="apps-ecommerce-reviews.html" className="link-reset fw-semibold">(4)</a></span>
                                                </td>
                                                <td>
                                                    <span className="badge p-1 text-bg-light fs-sm"> <img src="assets/images/flags/jp.svg" alt="" className="rounded-circle me-1" height="12" /> JP </span>
                                                </td>
                                                <td>$340.7k</td>
                                                <td>10th</td>
                                                <td>
...
<script src="assets/js/app.js"></script>
        ...
        <script src="assets/js/pages/ecommerce-product-views.js"></script>
    </div>
  )
}
