                ...
                <div className="container-fluid">
                    <div className="page-title-head d-flex align-items-center">
                        <div className="flex-grow-1">
                            <h4 className="page-main-title m-0">Seller Details</h4>
                        </div>
                        ...
                        <div className="col-xl-3">
                            <div className="card card-top-sticky">
                                    ...
                                    <div className="d-flex justify-content-between align-items-center rounded border-light p-2 bg-light-subtle border">
                                        <div className="d-flex justify-content-start align-items-center gap-3">
                                            <div className="avatar avatar-xl">
                                                <img src="assets/images/sellers/1.png" alt="avatar-store" className="img-fluid rounded-circle" />
                                            </div>
                                            <div>
                                        ...
                                        <div className="d-flex gap-2">
                                            ...
                                            <ul className="dropdown-menu dropdown-menu-end">
                                                ...
                                                <li><a className="dropdown-item text-danger" href="#">Report</a></li>
                                            </ul>
                                        </div>
                                    </div>
                                    ...
                                    <div className="mt-3">
                                        <div className="d-flex align-items-center gap-2 mb-2">
                                            <div className="avatar-sm bg-light d-flex align-items-center justify-content-center rounded">
                                                <i className="ti ti-user fs-xl text-muted"></i>
                                            </div>
                                            <p className="mb-0 fs-sm">Owner: <span className="fw-semibold">Sophie Martinez</span></p>
                                        </div>

                                        <div className="d-flex align-items-center gap-2 mb-2">
                                            <div className="avatar-sm bg-light d-flex align-items-center justify-content-center rounded">
                                                <i className="ti ti-briefcase fs-xl text-muted"></i>
                                            </div>
                                            <p className="mb-0 fs-sm">Business Type: <span className="fw-semibold">Fashion Retail</span></p>
                                        </div>

                                        <div className="d-flex align-items-center gap-2 mb-2">
                                            <div className="avatar-sm bg-light d-flex align-items-center justify-content-center rounded">
                                                <i className="ti ti-calendar-event fs-xl text-muted"></i>
                                            </div>
                                            <p className="mb-0 fs-sm">Founded: <span className="fw-semibold">2015</span></p>
                                        </div>

                                        <div className="d-flex align-items-center gap-2 mb-2">
                                            <div className="avatar-sm bg-light d-flex align-items-center justify-content-center rounded">
                                                <i className="ti ti-map-pin fs-xl text-muted"></i>
                                            </div>
                                            <p className="mb-0 fs-sm">Location: <span className="fw-semibold">Los Angeles, USA</span></p>
                                        </div>

                                        <div className="d-flex align-items-center gap-2 mb-2">
                                            <div className="avatar-sm bg-light d-flex align-items-center justify-content-center rounded">
                                                <i className="ti ti-mail fs-xl text-muted"></i>
                                            </div>
                                            <p className="mb-0 fs-sm">
                                                Support:
                                                <a href="mailto:help&#64;stylehub.com" className="text-primary fw-semibold">help&#64;stylehub.com</a>
                                            </p>
                                        </div>

                                        <div className="d-flex align-items-center gap-2 mb-2">
                                            <div className="avatar-sm bg-light d-flex align-items-center justify-content-center rounded">
                                                <i className="ti ti-world fs-xl text-muted"></i>
                                            </div>
                                            <p className="mb-0 fs-sm">
                                                Website:
                                                <a href="#!" className="text-primary fw-semibold">www.stylehub.com</a>
                                            </p>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div className="card-body border-top border-dashed">
                                    ...
                                    <form action="#">
                                        <div className="mb-3">
                                            <textarea className="form-control" id="exampleFormControlTextarea1" rows="4" placeholder="Enter your messages..."></textarea>
                                        </div>
                                        <div className="text-end">
                                ...
                                <div className="col">
                                    <div className="card">
                                        <div className="card-body">
                                            ...
                                            <p className="mb-0">
                                                <span className="text-success"><i className="ti ti-circle-filled"></i></span>
                                                <span className="text-nowrap text-muted">Total Orders</span>
                                                <span className="float-end"><b>15,320</b></span>
                                            </p>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div className="card">
                                        <div className="card-body">
                                            ...
                                            <div className="d-flex align-items-center gap-2 my-2">
                                                ...
                                                <h3 className="mb-0">$98.7k</h3>
                                            </div>
                                            <p className="mb-0">
                                                <span className="text-primary"><i className="ti ti-circle-filled"></i></span>
                                ...
                                <div className="col">
                                    <div className="card">
                                        <div className="card-body">
                                            ...
                                            <p className="mb-0">
                                                <span className="text-info"><i className="ti ti-circle-filled"></i></span>
                                                <span className="text-nowrap text-muted">Average Rating</span>
                                                <span className="float-end"><b>5k Reviews</b></span>
                                            </p>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div className="col">
                                    <div className="card">
                                        <div className="card-body">
                                            ...
                                            <p className="mb-0">
                                                <span className="text-secondary"><i className="ti ti-circle-filled"></i></span>
                                                <span className="text-nowrap text-muted">Total Products</span>
                                                <span className="float-end"><b>750 Variants</b></span>
                                            </p>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div data-table data-table-rows-per-page="8" className="card">
                                        <div className="card-header border-light justify-content-between">
                                            ...
                                            <div className="d-flex gap-1">
                                                ...
                                                <a href="apps-ecommerce-product-add.html" className="btn btn-danger ms-1"> <i className="ti ti-plus fs-sm me-2"></i> Add Product </a>
                                            </div>
                                        </div>
                                            ...
                                            <table className="table table-custom table-centered table-select table-hover w-100 mb-0">
                                                ...
                                                <tbody>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div className="d-flex align-items-center">
                                                                ...
                                                                <div>
                                                                    <h5 className="mb-0">
                                                                        <a data-sort="product" href="apps-ecommerce-product-details.html" className="link-reset">Gaming Laptop Pro</a>
                                                                    </h5>
                                                                </div>
                                                            </div>
                                                        </td>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div className="d-flex align-items-center">
                                                                ...
                                                                <div>
                                                                    <h5 className="mb-0">
                                                                        <a data-sort="product" href="apps-ecommerce-product-details.html" className="link-reset">Vintage Leather Wallet</a>
                                                                    </h5>
                                                                </div>
                                                            </div>
                                                        </td>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>$199.00</td>
                                                        <td>38</td>
                                                        <td><span className="badge badge-soft-danger fs-xxs">Out of Stock</span></td>
                                                        <td>
                                                            <div className="d-flex justify-content-center gap-1">
                                                                <a href="#" className="btn btn-default btn-icon btn-sm"><i className="ti ti-eye fs-lg"></i></a>
                                                                <a href="#" className="btn btn-default btn-icon btn-sm"><i className="ti ti-edit fs-lg"></i></a>
