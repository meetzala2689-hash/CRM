                ...
                <div className="container-fluid">
                    <div className="page-title-head d-flex align-items-center">
                        <div className="flex-grow-1">
                            <h4 className="page-main-title m-0">Shop Settings</h4>
                        </div>
                                        ...
                                        <div className="ins-wizard" data-wizard>
                                            <div className="row">
                                                <div className="col-md-4 col-xxl-3">
                                                    <ul className="nav flex-column wizard-bordered wizard-tabs nav-pills" data-wizard-nav role="tablist">
                                                        <li className="nav-item">
                                                            <a className="nav-link active" data-bs-toggle="tab" href="#shopStepGeneral">
                                                                <span className="d-flex align-items-center">
                                                                    <div className="avatar-md">
                                                                        <span className="avatar-title bg-light rounded">
                                                                            <i className="ti ti-building-store fs-24"></i>
                                                                        </span>
                                                                    </div>
                                                                    <span className="flex-grow-1 ms-2 text-truncate">
                                                                        <span className="fw-semibold text-body d-block fs-base">General Info</span>
                                                                        <span className="fs-xs mb-0">Shop basics</span>
                                                                    </span>
                                                                </span>
                                                            </a>
                                                        </li>
                                                        ...
                                                        <li className="nav-item">
                                                            <a className="nav-link" data-bs-toggle="tab" href="#shopStepStore">
                                                                <span className="d-flex align-items-center">
                                                                    <div className="avatar-md">
                                                                        <span className="avatar-title bg-light rounded">
                                                                    ...
                                                                    <span className="flex-grow-1 ms-2 text-truncate">
                                                                        <span className="fw-semibold text-body d-block fs-base">Store Details</span>
                                                                        <span className="fs-xs mb-0">Business info</span>
                                                                    </span>
                                                                </span>
                                                            </a>
                                                        </li>
                                                        ...
                                                        <li className="nav-item">
                                                            <a className="nav-link" data-bs-toggle="tab" href="#shopStepBranding">
                                                                <span className="d-flex align-items-center">
                                                                    <div className="avatar-md">
                                                                        <span className="avatar-title bg-light rounded">
                                                                            <i className="ti ti-palette fs-24"></i>
                                                                        </span>
                                                                    </div>
                                                                    <span className="flex-grow-1 ms-2 text-truncate">
                                                                        <span className="fw-semibold text-body d-block fs-base">Branding</span>
                                                                        <span className="fs-xs mb-0">Logo & colors</span>
                                                                    </span>
                                                                </span>
                                                            </a>
                                                        </li>
                                                        ...
                                                        <li className="nav-item">
                                                            <a className="nav-link" data-bs-toggle="tab" href="#shopStepCurrency">
                                                                <span className="d-flex align-items-center">
                                                                    <div className="avatar-md">
                                                                        <span className="avatar-title bg-light rounded">
                                                                            <i className="ti ti-pig-money fs-24"></i>
                                                                        </span>
                                                                    </div>
                                                                    <span className="flex-grow-1 ms-2 text-truncate">
                                                                        <span className="fw-semibold text-body d-block fs-base">Currency & Tax</span>
                                                                        <span className="fs-xs mb-0">Regional setup</span>
                                                                    </span>
                                                                </span>
                                                            </a>
                                                        </li>
                                                        ...
                                                        <li className="nav-item">
                                                            <a className="nav-link" data-bs-toggle="tab" href="#shopStepShipping">
                                                                <span className="d-flex align-items-center">
                                                                    <div className="avatar-md">
                                                                        <span className="avatar-title bg-light rounded">
                                                                    ...
                                                                    <span className="flex-grow-1 ms-2 text-truncate">
                                                                        <span className="fw-semibold text-body d-block fs-base">Shipping</span>
                                                                        <span className="fs-xs mb-0">Delivery setup</span>
                                                                    </span>
                                                                </span>
                                                            </a>
                                                        </li>
                                                        ...
                                                        <li className="nav-item">
                                                            <a className="nav-link" data-bs-toggle="tab" href="#shopStepPayment">
                                                                <span className="d-flex align-items-center">
                                                                    <div className="avatar-md">
                                                                        <span className="avatar-title bg-light rounded">
                                                                    ...
                                                                    <span className="flex-grow-1 ms-2 text-truncate">
                                                                        <span className="fw-semibold text-body d-block fs-base">Payments</span>
                                                                        <span className="fs-xs mb-0">Gateways & modes</span>
                                                                    </span>
                                                                </span>
                                                            </a>
                                                        </li>
                                                        ...
                                                        <li className="nav-item">
                                                            <a className="nav-link" data-bs-toggle="tab" href="#shopStepNotifications">
                                                                <span className="d-flex align-items-center">
                                                                    <div className="avatar-md">
                                                                        <span className="avatar-title bg-light rounded">
                                                                    ...
                                                                    <span className="flex-grow-1 ms-2 text-truncate">
                                                                        <span className="fw-semibold text-body d-block fs-base">Notifications</span>
                                                                        <span className="fs-xs mb-0">Emails & alerts</span>
                                                                    </span>
                                                                </span>
                                                            </a>
                                                        </li>
                                                        ...
                                                        <li className="nav-item">
                                                            <a className="nav-link" data-bs-toggle="tab" href="#shopStepInvoices">
                                                                <span className="d-flex align-items-center">
                                                                    <div className="avatar-md">
                                                                        <span className="avatar-title bg-light rounded">
                                                                    ...
                                                                    <span className="flex-grow-1 ms-2 text-truncate">
                                                                        <span className="fw-semibold text-body d-block fs-base">Invoices & Receipts</span>
                                                                        <span className="fs-xs mb-0">Billing templates</span>
                                                                    </span>
                                                                </span>
                                                            </a>
                                                        </li>
                                                        ...
                                                        <li className="nav-item">
                                                            <a className="nav-link" data-bs-toggle="tab" href="#shopStepLegal">
                                                                <span className="d-flex align-items-center">
                                                                    <div className="avatar-md">
                                                                        <span className="avatar-title bg-light rounded">
                                                                            <i className="ti ti-world fs-24"></i>
                                                                        </span>
                                                                    </div>
                                                                    <span className="flex-grow-1 ms-2 text-truncate">
                                                                        <span className="fw-semibold text-body d-block fs-base">SEO & Legal</span>
                                                                        <span className="fs-xs mb-0">Policies & SEO</span>
                                                                    </span>
                                                                </span>
                                                            </a>
                                                        </li>
                                                        ...
                                                        <li className="nav-item">
                                                            <a className="nav-link" data-bs-toggle="tab" href="#shopStepIntegrations">
                                                                <span className="d-flex align-items-center">
                                                                    <div className="avatar-md">
                                                                        <span className="avatar-title bg-light rounded">
                                                                            <i className="ti ti-plug fs-24"></i>
                                                                        </span>
                                                                    </div>
                                                                    <span className="flex-grow-1 ms-2 text-truncate">
                                                                        <span className="fw-semibold text-body d-block fs-base">Integrations</span>
                                                                        <span className="fs-xs mb-0">3rd-party apps</span>
                                                                    </span>
                                                                </span>
                                                            </a>
                                                        </li>
                                                        ...
                                                        <li className="nav-item">
                                                            <a className="nav-link" data-bs-toggle="tab" href="#shopStepBackup">
                                                                <span className="d-flex align-items-center">
                                                                    <div className="avatar-md">
                                                                        <span className="avatar-title bg-light rounded">
                                                                            <i className="ti ti-database fs-24"></i>
                                                                        </span>
                                                                    </div>
                                                                    <span className="flex-grow-1 ms-2 text-truncate">
                                                                        <span className="fw-semibold text-body d-block fs-base">Backup & Restore</span>
                                                                        <span className="fs-xs mb-0">Data recovery</span>
                                                                    </span>
                                                                </span>
                                                            </a>
                                                        </li>
                                                        ...
                                                        <li className="nav-item">
                                                            <a className="nav-link" data-bs-toggle="tab" href="#shopStepAdvanced">
                                                                <span className="d-flex align-items-center">
                                                                    <div className="avatar-md">
                                                                        <span className="avatar-title bg-light rounded">
                                                                    ...
                                                                    <span className="flex-grow-1 ms-2 text-truncate">
                                                                        <span className="fw-semibold text-body d-block fs-base">Advanced</span>
                                                                        <span className="fs-xs mb-0">System controls</span>
                                                                    </span>
                                                                </span>
                                                            </a>
                                                        </li>
                                                ...
                                                <div className="col-md-8 col-xxl-9">
                                                    <div className="tab-content border border-dashed rounded p-4" data-wizard-content>
                                                
                                                        <div className="tab-pane fade show active" id="shopStepGeneral">
                                                            <div className="row">
                                                                <div className="col-xl-6 mb-3">
                                                                    <label className="form-label">Shop Name</label>
                                                                    <input type="text" className="form-control" placeholder="e.g., Vona Store" required />
                                                                </div>
                                                                <div className="col-xl-6 mb-3">
                                                                    <label className="form-label">Support Email</label>
                                                                    <input type="email" className="form-control" placeholder="support&#64;domain.com" required />
                                                                </div>
                                                                <div className="col-xl-6 mb-3">
                                                                ...
                                                                <div className="col-xl-6 mb-3">
                                                                    ...
                                                                    <input type="text" className="form-control" placeholder="Mon-Fri, 9 AM - 6 PM" />
                                                                </div>
                                                            </div>
                                                            <div className="d-flex justify-content-end mt-3">
                                                                <button type="button" className="btn btn-primary" data-wizard-next>Next: Store Details →</button>
                                                            </div>
                                                        </div>
                                                        <div className="tab-pane fade" id="shopStepStore">
                                                            <div className="row">
                                                                <div className="col-xl-6 mb-3">
                                                                    <label className="form-label">Business Name</label>
                                                                    <input type="text" className="form-control" placeholder="e.g., Acme Retail LLC" />
                                                                </div>
                                                                <div className="col-xl-6 mb-3">
                                                                    <label className="form-label">Registration Number</label>
                                                                    <input type="text" className="form-control" placeholder="e.g., 123456789" />
                                                                </div>
                                                                <div className="col-xl-12 mb-3">
                                                                    <label className="form-label">Business Address</label>
                                                                    <textarea className="form-control" rows="2" placeholder="123 Main Street, City, Country"></textarea>
                                                                </div>
                                                            </div>
                                                            <div className="d-flex justify-content-between mt-3">
                                                                <button type="button" className="btn btn-secondary" data-wizard-prev>← Back</button>
                                                                <button type="button" className="btn btn-primary" data-wizard-next>Next: Branding →</button>
                                                            </div>
                                                        </div>
                                                        <div className="tab-pane fade" id="shopStepBranding">
                                                            <div className="row">
                                                                <div className="col-xl-6 mb-3">
                                                                ...
                                                                <div className="col-xl-6 mb-3">
                                                                    ...
                                                                    <input type="color" className="form-control form-control-color" value="#4f46e5" />
                                                                </div>
                                                                <div className="col-xl-6 mb-3">
                                                                    <label className="form-label">Accent Color</label>
                                                                    <input type="color" className="form-control form-control-color" value="#22c55e" />
                                                                </div>
                                                            </div>
                                                            <div className="d-flex justify-content-between mt-3">
                                                                <button type="button" className="btn btn-secondary" data-wizard-prev>← Back</button>
                                                                <button type="button" className="btn btn-primary" data-wizard-next>Next: Currency & Tax →</button>
                                                            </div>
                                                        </div>
                                                        <div className="tab-pane fade" id="shopStepCurrency">
                                                            <div className="row">
                                                                <div className="col-xl-6 mb-3">
                                                                ...
                                                                <div className="col-xl-6 mb-3">
                                                                    ...
                                                                    <input type="number" className="form-control" placeholder="e.g., 7.5" />
                                                                </div>
                                                            ...
                                                            <div className="d-flex justify-content-between mt-3">
                                                                <button type="button" className="btn btn-secondary" data-wizard-prev>← Back</button>
                                                                <button type="button" className="btn btn-primary" data-wizard-next>Next: Shipping →</button>
                                                            </div>
                                                        </div>
                                                        <div className="tab-pane fade" id="shopStepShipping">
                                                            <div className="row">
                                                                <div className="col-xl-6 mb-3">
                                                                    <label className="form-label">Default Origin</label>
                                                                    <input type="text" className="form-control" placeholder="California, USA" />
                                                                </div>
                                                                <div className="col-xl-6 mb-3">
                                                            ...
                                                            <div className="d-flex justify-content-between mt-3">
                                                                <button type="button" className="btn btn-secondary" data-wizard-prev>← Back</button>
                                                                <button type="button" className="btn btn-primary" data-wizard-next>Next: Payments →</button>
                                                            </div>
                                                        </div>
                                                        <div className="tab-pane fade" id="shopStepPayment">
                                                            <div className="row">
                                                                <div className="col-xl-6 mb-3">
                                                                    <div className="form-check form-switch">
                                                                        <input className="form-check-input" type="checkbox" checked />
                                                                ...
                                                                <div className="col-xl-6 mb-3">
                                                                    ...
                                                                    <input type="text" className="form-control" placeholder="e.g., Abcd1234" />
                                                                </div>
                                                            </div>
                                                            <div className="d-flex justify-content-between mt-3">
                                                                <button type="button" className="btn btn-secondary" data-wizard-prev>← Back</button>
                                                                <button type="button" className="btn btn-primary" data-wizard-next>Next: Notifications →</button>
                                                            </div>
                                                        </div>
                                                        <div className="tab-pane fade" id="shopStepNotifications">
                                                            ...
                                                            <div className="d-flex justify-content-between mt-3">
                                                                <button type="button" className="btn btn-secondary" data-wizard-prev>← Back</button>
                                                                <button type="button" className="btn btn-primary" data-wizard-next>Next: Invoices & Receipts →</button>
                                                            </div>
                                                        </div>
                                                        <div className="tab-pane fade" id="shopStepInvoices">
                                                            <div className="mb-3">
                                                                <label className="form-label">Invoice Prefix</label>
                                                                <input type="text" className="form-control" placeholder="INV-" />
                                                            </div>
                                                            <div className="form-check form-switch mb-3">
                                                                <input className="form-check-input" type="checkbox" checked />
                                                            ...
                                                            <div className="d-flex justify-content-between mt-3">
                                                                <button type="button" className="btn btn-secondary" data-wizard-prev>← Back</button>
                                                                <button type="button" className="btn btn-primary" data-wizard-next>Next: SEO & Legal →</button>
                                                            </div>
                                                        </div>
                                                        <div className="tab-pane fade" id="shopStepLegal">
                                                            <div className="mb-3">
                                                                <label className="form-label">Meta Title</label>
                                                                <input type="text" className="form-control" placeholder="Your Shop Title" />
                                                            </div>
                                                            <div className="mb-3">
                                                                <label className="form-label">Meta Description</label>
                                                                <textarea className="form-control" rows="2" placeholder="Brief description for SEO"></textarea>
                                                            </div>
                                                            <div className="mb-3">
                                                                <label className="form-label">Privacy Policy URL</label>
                                                                <input type="url" className="form-control" placeholder="https://example.com/privacy" />
                                                            </div>
                                                            <div className="mb-3">
                                                                <label className="form-label">Terms & Conditions URL</label>
                                                                <input type="url" className="form-control" placeholder="https://example.com/terms" />
                                                            </div>
                                                            <div className="d-flex justify-content-between mt-3">
                                                                <button type="button" className="btn btn-secondary" data-wizard-prev>← Back</button>
                                                                <button type="button" className="btn btn-primary" data-wizard-next>Next: Integrations →</button>
                                                            </div>
                                                        </div>
                                                        <div className="tab-pane fade" id="shopStepIntegrations">
                                                            <div className="mb-3">
                                                                <label className="form-label">Google Analytics ID</label>
                                                                <input type="text" className="form-control" placeholder="UA-XXXXX-Y" />
                                                            </div>
                                                            <div className="mb-3">
                                                            ...
                                                            <div className="mb-3">
                                                                ...
                                                                <input type="text" className="form-control" placeholder="key-xxxxx" />
                                                            </div>
                                                            <div className="d-flex justify-content-between mt-3">
                                                                <button type="button" className="btn btn-secondary" data-wizard-prev>← Back</button>
                                                                <button type="button" className="btn btn-primary" data-wizard-next>Next: Backup & Restore →</button>
                                                            </div>
                                                        </div>
                                                        <div className="tab-pane fade" id="shopStepBackup">
                                                            <div className="mb-3">
                                                                <button className="btn btn-outline-primary w-100">Create Manual Backup</button>
                                                            </div>
                                                            <div className="mb-3">
                                                            ...
                                                            <div className="d-flex justify-content-between mt-3">
                                                                <button type="button" className="btn btn-secondary" data-wizard-prev>← Back</button>
                                                                <button type="button" className="btn btn-primary" data-wizard-next>Next: Advanced →</button>
                                                            </div>
                                                        </div>
                                                        <div className="tab-pane fade" id="shopStepAdvanced">
                                                            <div className="form-check form-switch mb-3">
                                                                <input className="form-check-input" type="checkbox" />
                                                            ...
                                                            <div className="mb-3">
                                                                ...
                                                                <textarea className="form-control" rows="3" placeholder="Paste custom JavaScript here"></textarea>
                                                            </div>
                                                            <div className="d-flex justify-content-between mt-3">
                                                                <button type="button" className="btn btn-secondary" data-wizard-prev>← Back</button>
                                                                <button type="submit" className="btn btn-success">Save All Settings</button>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
