                        ...
                        <div className="col-lg-12">
                            <form className="bg-light-subtle rounded border p-3">
                                <div className="d-flex flex-wrap justify align-items-center gap-3">
                                    ...
                                    <h3 className="mb-0 fs-xl flex-grow-1"><span data-target="1025">0</span> Products</h3>

                                    <div className="d-flex gap-1">
                                        <a href="apps-ecommerce-products-grid.html" className="btn btn-soft-primary btn-icon active">
                                            <i className="ti ti-category fs-lg"></i>
                                        </a>
                                        <a href="apps-ecommerce-products.html" className="btn btn-soft-primary btn-icon">
                                    ...
                                    <div className="card-body p-0">
                                        ...
                                        <div className="p-3 border-bottom border-dashed">
                                            ...
                                            <div className="d-flex align-items-center gap-2 text-muted py-1">
                                                <div className="form-check flex-grow-1">
                                                    ...
                                                    <label for="cat-electronics" className="form-check-label mb-0">Electronics</label>
                                                </div>
                                                <div className="flex-shrink-0">
                                                    <span className="badge text-bg-light">8</span>
                                                </div>
                                            </div>
                                            <div className="d-flex align-items-center gap-2 text-muted py-1">
                                                <div className="form-check flex-grow-1">
                                                    <input type="checkbox" id="cat-computers" className="form-check-input" />
                                                    <label for="cat-computers" className="form-check-label mb-0">Computers</label>
                                                </div>
                                                <div className="flex-shrink-0">
                                            ...
                                            <div className="d-flex align-items-center gap-2 text-muted py-1">
                                                <div className="form-check flex-grow-1">
                                                    ...
                                                    <label for="cat-home-office" className="form-check-label mb-0">Home & Office</label>
                                                </div>
                                                <div className="flex-shrink-0">
                                                    <span className="badge text-bg-light">6</span>
                                                </div>
                                            </div>
                                            <div className="d-flex align-items-center gap-2 text-muted py-1">
                                                <div className="form-check flex-grow-1">
                                                    <input type="checkbox" id="cat-accessories" className="form-check-input" />
                                                    <label for="cat-accessories" className="form-check-label mb-0">Accessories</label>
                                                </div>
                                            </div>
                                            <div className="d-flex align-items-center gap-2 text-muted py-1">
                                                <div className="form-check flex-grow-1">
                                                    <input type="checkbox" id="cat-gaming" className="form-check-input" />
                                                    <label for="cat-gaming" className="form-check-label mb-0">Gaming</label>
                                                </div>
                                                <div className="flex-shrink-0">
                                                    <span className="badge text-bg-light">9</span>
                                                </div>
                                            </div>
                                            <div className="d-flex align-items-center gap-2 text-muted py-1">
                                                <div className="form-check flex-grow-1">
                                                    <input type="checkbox" id="cat-mobile" className="form-check-input" />
                                                    <label for="cat-mobile" className="form-check-label mb-0">Mobile Phones</label>
                                                </div>
                                                <div className="flex-shrink-0">
                                                    <span className="badge text-bg-light">12</span>
                                                </div>
                                            </div>
                                            <div className="d-flex align-items-center gap-2 text-muted py-1">
                                                <div className="form-check flex-grow-1">
                                                    <input type="checkbox" id="cat-appliances" className="form-check-input" />
                                                    <label for="cat-appliances" className="form-check-label mb-0">Appliances</label>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div className="p-3 border-bottom border-dashed">
                                            ...
                                            <div className="d-flex align-items-center gap-2 text-muted py-1">
                                                <div className="form-check flex-grow-1">
                                                    ...
                                                    <label for="brand-apple" className="form-check-label mb-0">Apple</label>
                                                </div>
                                                <div className="flex-shrink-0">
                                                    <span className="badge text-bg-light">14</span>
                                                </div>
                                            </div>
                                            ...
                                            <div className="d-flex align-items-center gap-2 text-muted py-1">
                                                <div className="form-check flex-grow-1">
                                                    ...
                                                    <label for="brand-samsung" className="form-check-label mb-0">Samsung</label>
                                                </div>
                                                <div className="flex-shrink-0">
                                            ...
                                            <div className="d-flex align-items-center gap-2 text-muted py-1">
                                                <div className="form-check flex-grow-1">
                                                    ...
                                                    <label for="brand-sony" className="form-check-label mb-0">Sony</label>
                                                </div>
                                            </div>
                                            ...
                                            <div className="d-flex align-items-center gap-2 text-muted py-1">
                                                <div className="form-check flex-grow-1">
                                                    ...
                                                    <label for="brand-dell" className="form-check-label mb-0">Dell</label>
                                                </div>
                                                <div className="flex-shrink-0">
                                                    <span className="badge text-bg-light">7</span>
                                                </div>
                                            </div>
                                            ...
                                            <div className="d-flex align-items-center gap-2 text-muted py-1">
                                                <div className="form-check flex-grow-1">
                                                    ...
                                                    <label for="brand-hp" className="form-check-label mb-0">HP</label>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div className="p-3">
                                            ...
                                            <div className="form-check py-1">
                                                ...
                                                <label for="5-star-rating" className="form-check-label d-block">
                                                    <span className="d-flex align-items-center">
                                                        ...
                                                        <span className="flex-shrink-0">
                                                            <span className="badge text-bg-light">120</span>
                                                        </span>
                                                    </span>
                                                </label>
                                            </div>
                                            ...
                                            <div className="form-check py-1">
                                                ...
                                                <label for="4-star-rating" className="form-check-label d-block">
                                                    <span className="d-flex align-items-center">
                                                        <span className="flex-grow-1 d-inline-flex align-items-center">
                                                            <i className="ti ti-star-filled text-warning"></i>
                                                            <i className="ti ti-star-filled text-warning"></i>
                                                            <i className="ti ti-star-filled text-warning"></i>
                                                            <i className="ti ti-star-filled text-warning"></i>
                                                            <i className="ti ti-star-filled text-muted"></i>
                                                            <span className="text-muted ms-1">4 Stars & Up</span>
                                                        </span>
                                                        <span className="flex-shrink-0">
                                                            <span className="badge text-bg-light">210</span>
                                                        </span>
                                                    </span>
                                                </label>
                                            </div>
                                            ...
                                            <div className="form-check py-1">
                                                ...
                                                <label for="3-star-rating" className="form-check-label d-block">
                                                    <span className="d-flex align-items-center">
                                                        <span className="flex-grow-1 d-inline-flex align-items-center">
                                                            <i className="ti ti-star-filled text-warning"></i>
                                                            <i className="ti ti-star-filled text-warning"></i>
                                                        ...
                                                        <span className="flex-shrink-0">
                                                            <span className="badge text-bg-light">325</span>
                                                        </span>
                                                    </span>
                                                </label>
                                            </div>
                                            ...
                                            <div className="form-check py-1">
                                                ...
                                                <label for="2-star-rating" className="form-check-label d-block">
                                                    <span className="d-flex align-items-center">
                                                        <span className="flex-grow-1 d-inline-flex align-items-center">
                                                            <i className="ti ti-star-filled text-warning"></i>
                                                            <i className="ti ti-star-filled text-warning"></i>
                                                        ...
                                                        <span className="flex-shrink-0">
                                                            <span className="badge text-bg-light">145</span>
                                                        </span>
                                                    </span>
                                                </label>
                                            </div>
                                            ...
                                            <div className="form-check pt-1">
                                                ...
                                                <label for="1-star-rating" className="form-check-label d-block">
                                                    <span className="d-flex align-items-center">
                                                        <span className="flex-grow-1 d-inline-flex align-items-center">
                                                            <i className="ti ti-star-filled text-warning"></i>
                                                            <i className="ti ti-star-filled text-muted"></i>
                                                        ...
                                                        <span className="flex-shrink-0">
                                                            <span className="badge text-bg-light">58</span>
                                                        </span>
                                                    </span>
                                                </label>
                                            </div>
                            ...
                            <div className="row row-cols-xxl-4 row-cols-lg-3 row-cols-sm-2 row-col-1 g-2">
                                <div className="col">
                                    <article className="card h-100 mb-2">
                                        ...
                                        <div className="badge text-bg-success badge-label fs-base rounded position-absolute top-0 start-0 m-3">15% OFF</div>

                                
                                        <div className="card-body pb-0">
                                            <div className="p-3">
                                                <img src="assets/images/products/1.png" alt="modern-sofa" className="img-fluid" />
                                            </div>
                                            ...
                                            <div>
                                                ...
                                                <span className="ms-1">
                                                    <a href="apps-ecommerce-reviews.html" className="link-reset fw-semibold">(45)</a>
                                                </span>
                                            </div>
                                        </div>
                                        ...
                                        <div className="card-footer bg-transparent d-flex justify-content-between">
                                            <div className="d-flex justify-content-start align-items-center gap-2">
                                                <h5 className="text-success d-flex align-items-center gap-2 mb-0">
                                                    <span className="text-muted text-decoration-line-through">$899.00</span>
                                                    $764.15
                                                </h5>
                                            </div>
                                ...
                                <div className="col">
                                    <article className="card h-100 mb-2">
                                        ...
                                        <div className="card-body pb-0">
                                            <div className="p-3">
                                                <img src="assets/images/products/2.png" alt="funky-shoes" className="img-fluid" />
                                            </div>
                                
                                            <h6 className="card-title fs-sm lh-base mb-2">
                                                <a href="apps-ecommerce-product-details.html" className="link-reset">Funky Streetwear Sneakers - Neon Splash</a>
                                            </h6>
                                            ...
                                            <div>
                                                ...
                                                <span className="ms-1">
                                                    <a href="apps-ecommerce-reviews.html" className="link-reset fw-semibold">(32)</a>
                                                </span>
                                            </div>
                                        </div>
                                        ...
                                        <div className="card-footer bg-transparent d-flex justify-content-between">
                                            <div className="d-flex justify-content-start align-items-center gap-2">
                                                <h5 className="text-danger d-flex align-items-center gap-2 mb-0">
                                                    <span className="text-muted text-decoration-line-through">$59.99</span>
                                                    $44.99
                                                </h5>
                                            </div>
                                            <a className="btn btn-sm btn-icon btn-primary" href="#!">
                                ...
                                <div className="col">
                                    <article className="card h-100 mb-2">
                                        ...
                                        <div className="badge text-bg-danger badge-label fs-base rounded position-absolute top-0 start-0 m-3">15% OFF</div>

                              
                                        <div className="card-body pb-0">
                                            <div className="p-3">
                                                <img src="assets/images/products/3.png" alt="earbuds" className="img-fluid" />
                                            </div>
                                    
                                            <h6 className="card-title fs-sm lh-base mb-2">
                                                <a href="apps-ecommerce-product-details.html" className="link-reset">Noise Canceling Wireless Earbuds - Black Edition</a>
                                            </h6>
                                            ...
                                            <div>
                                                ...
                                                <span className="ms-1">
                                                    <a href="apps-ecommerce-reviews.html" className="link-reset fw-semibold">(58)</a>
                                                </span>
                                            </div>
                                        </div>
                                ...
                                <div className="col">
                                    <article className="card h-100 mb-2">
                                        ...
                                        <div className="card-body pb-0">
                                            <div className="p-3">
                                                <img src="assets/images/products/4.png" alt="wooden-chair" className="img-fluid" />
                                            </div>
                                    
                                            <h6 className="card-title fs-sm lh-base mb-2">
                                                <a href="apps-ecommerce-product-details.html" className="link-reset">Minimalist Solid Wood Dining Chair</a>
                                            </h6>
                                            ...
                                            <div>
                                                ...
                                                <span className="ms-1">
                                                    <a href="apps-ecommerce-reviews.html" className="link-reset fw-semibold">(46)</a>
                                                </span>
                                            </div>
                                        </div>
                                        ...
                                        <div className="card-footer bg-transparent d-flex justify-content-between">
                                            <div className="d-flex justify-content-start align-items-center gap-2">
                                                <h5 className="text-danger d-flex align-items-center gap-2 mb-0">
                                                    <span className="text-muted text-decoration-line-through">$120.00</span>
                                                    $96.00
                                                </h5>
                                            </div>
                                            <a className="btn btn-sm btn-icon btn-primary" href="#!">
                                ...
                                <div className="col">
                                    <article className="card h-100 mb-2">
                                        ...
                                        <div className="card-body pb-0">
                                            <div className="p-3">
                                                <img src="assets/images/products/5.png" alt="black-wall-watch" className="img-fluid" />
                                            </div>
                                            <h6 className="card-title fs-sm lh-base mb-2">
                                                <a href="apps-ecommerce-product-details.html" className="link-reset">Modern Black Minimalist Wall Clock</a>
                                            </h6>
                                            ...
                                            <div>
                                                ...
                                                <span className="ms-1">
                                                    <a href="apps-ecommerce-reviews.html" className="link-reset fw-semibold">(62)</a>
                                                </span>
                                            </div>
                                        </div>
                                ...
                                <div className="col">
                                    <article className="card h-100 mb-2">
                                        ...
                                        <div className="badge text-bg-danger badge-label fs-base rounded position-absolute top-0 start-0 m-3">20% OFF</div>

                              
                                        <div className="card-body pb-0">
                                            <div className="p-3">
                                                <img src="assets/images/products/6.png" alt="brown-chair" className="img-fluid" />
                                            </div>
                                        
                                            <h6 className="card-title fs-sm lh-base mb-2">
                                                <a href="apps-ecommerce-product-details.html" className="link-reset">Elegant Brown Wooden Chair</a>
                                            </h6>
                                            ...
                                            <div>
                                                ...
                                                <span className="ms-1">
                                                    <a href="apps-ecommerce-reviews.html" className="link-reset fw-semibold">(48)</a>
                                                </span>
                                            </div>
                                        </div>
                                ...
                                <div className="col">
                                    <article className="card h-100 mb-2">
                                        ...
                                        <div className="card-body pb-0">
                                            <div className="p-3">
                                                <img src="assets/images/products/7.png" alt="imac" className="img-fluid" />
                                            </div>
                                    
                                            <h6 className="card-title fs-sm lh-base mb-2">
                                                <a href="apps-ecommerce-product-details.html" className="link-reset">Apple iMac 24" Retina 4.5K Display</a>
                                            </h6>
                                            ...
                                            <div>
                                                ...
                                                <span className="ms-1">
                                                    <a href="apps-ecommerce-reviews.html" className="link-reset fw-semibold">(65)</a>
                                                </span>
                                            </div>
                                        </div>
                                        ...
                                        <div className="card-footer bg-transparent d-flex justify-content-between">
                                            <div className="d-flex justify-content-start align-items-center gap-2">
                                                <h5 className="text-danger d-flex align-items-center gap-2 mb-0">
                                                    <span className="text-muted text-decoration-line-through">$1,299.00</span>
                                                    $1,039.20
                                                </h5>
                                            </div>
                                            <a className="btn btn-sm btn-icon btn-primary" href="#!">
                                ...
                                <div className="col">
                                    <article className="card h-100 mb-2">
                                        ...
                                        <div className="card-body pb-0">
                                            <div className="p-3">
                                                <img src="assets/images/products/8.png" alt="coolest-chair" className="img-fluid" />
                                            </div>
                                    
                                            <h6 className="card-title fs-sm lh-base mb-2">
                                                <a href="apps-ecommerce-product-details.html" className="link-reset">Coolest Ergonomic Lounge Chair</a>
                                            </h6>
                                            ...
                                            <div>
                                                ...
                                                <span className="ms-1">
                                                    <a href="apps-ecommerce-reviews.html" className="link-reset fw-semibold">(52)</a>
                                                </span>
                                            </div>
                                        </div>
                                        ...
                                        <div className="card-footer bg-transparent d-flex justify-content-between">
                                            <div className="d-flex justify-content-start align-items-center gap-2">
                                                <h5 className="text-danger d-flex align-items-center gap-2 mb-0">
                                                    <span className="text-muted text-decoration-line-through">$320.00</span>
                                                    $256.00
                                                </h5>
                                            </div>
                                            <a className="btn btn-sm btn-icon btn-primary" href="#!">
                                ...
                                <div className="col">
                                    <article className="card h-100 mb-2">
                                        ...
                                        <div className="card-body pb-0">
                                            <div className="p-3">
                                                <img src="assets/images/products/9.png" alt="ipad" className="img-fluid" />
                                            </div>
                                          
                                            <h6 className="card-title fs-sm lh-base mb-2">
                                                <a href="apps-ecommerce-product-details.html" className="link-reset">Apple iPad 10.9" Wi-Fi 64GB - Silver</a>
                                            </h6>
                                            ...
                                            <div>
                                                ...
                                                <span className="ms-1">
                                                    <a href="apps-ecommerce-reviews.html" className="link-reset fw-semibold">(142)</a>
                                                </span>
                                            </div>
                                        </div>
                                        ...
                                        <div className="card-footer bg-transparent d-flex justify-content-between">
                                            <div className="d-flex justify-content-start align-items-center gap-2">
                                                <h5 className="text-danger d-flex align-items-center gap-2 mb-0">
                                                    <span className="text-muted text-decoration-line-through">$449.00</span>
                                                    $359.20
                                                </h5>
                                            </div>
                                            <a className="btn btn-sm btn-icon btn-primary" href="#!">
                                ...
                                <div className="col">
                                    <article className="card h-100 mb-2">
                                        <div className="card-body pb-0">
                                            <div className="p-3">
                                                <img src="assets/images/products/10.png" alt="minimal-jacket" className="img-fluid" />
                                            </div>
                                            <h6 className="card-title fs-sm lh-base mb-2">
                                                <a href="apps-ecommerce-product-details.html" className="link-reset">Minimalist Denim Jacket – Indigo Blue</a>
                                            </h6>
                                            <div>
                                                <span className="text-warning">
                                                    <i className="ti ti-star-filled"></i>
                                                ...
                                                <span className="ms-1">
                                                    <a href="apps-ecommerce-reviews.html" className="link-reset fw-semibold">(54)</a>
                                                </span>
                                            </div>
                                        </div>
                                        <div className="card-footer bg-transparent d-flex justify-content-between">
                                            <div className="d-flex align-items-center gap-2">
                                                <h5 className="text-danger d-flex align-items-center gap-2 mb-0">
                                                    <span className="text-muted text-decoration-line-through">$89.00</span>
                                                    $64.00
                                                </h5>
                                            </div>
                                            <a className="btn btn-sm btn-icon btn-primary" href="#!">
                                ...
                                <div className="col">
                                    <article className="card h-100 mb-2">
                                        <div className="card-body pb-0">
                                            <div className="p-3">
                                                <img src="assets/images/products/1.png" alt="smartwatch" className="img-fluid" />
                                            </div>
                                            <h6 className="card-title fs-sm lh-base mb-2">
                                                <a href="apps-ecommerce-product-details.html" className="link-reset">Next-Gen Smartwatch S9 – Graphite Black</a>
                                            </h6>
                                            <div>
                                                <span className="text-warning">
                                                    <i className="ti ti-star-filled"></i>
                                                ...
                                                <span className="ms-1">
                                                    <a href="apps-ecommerce-reviews.html" className="link-reset fw-semibold">(128)</a>
                                                </span>
                                            </div>
                                        </div>
                                        <div className="card-footer bg-transparent d-flex justify-content-between">
                                            <div className="d-flex align-items-center gap-2">
                                                <h5 className="text-danger d-flex align-items-center gap-2 mb-0">
                                                    <span className="text-muted text-decoration-line-through">$249.00</span>
                                                    $199.00
                                                </h5>
                                            </div>
                                            <a className="btn btn-sm btn-icon btn-primary" href="#!">
                                ...
                                <div className="col">
                                    <article className="card h-100 mb-2">
                                        <div className="card-body pb-0">
                                            <div className="p-3">
                                                <img src="assets/images/products/2.png" alt="headphones" className="img-fluid" />
                                            </div>
                                            <h6 className="card-title fs-sm lh-base mb-2">
                                                <a href="apps-ecommerce-product-details.html" className="link-reset">Noise-Cancel Pro Headphones – Arctic White</a>
                                            </h6>
                                            <div>
                                                <span className="text-warning">
                                                    <i className="ti ti-star-filled"></i>
                                                ...
                                                <span className="ms-1">
                                                    <a href="apps-ecommerce-reviews.html" className="link-reset fw-semibold">(87)</a>
                                                </span>
                                            </div>
                                        </div>
                                        <div className="card-footer bg-transparent d-flex justify-content-between">
                                            <div className="d-flex align-items-center gap-2">
                                                <h5 className="text-danger d-flex align-items-center gap-2 mb-0">
                                                    <span className="text-muted text-decoration-line-through">$199.99</span>
                                                    $159.99
                                                </h5>
                                            </div>
                                            <a className="btn btn-sm btn-icon btn-primary" href="#!">
