                            ...
                            <div className="card mb-1">
                                <div className="card-body">
                                    ...
                                    <div className="d-flex align-items-center gap-2 my-3">
                                        ...
                                        <h3 className="mb-0"><span data-target="2,240">0</span></h3>
                                    ...
                                    <p className="mb-0">
                                        ...
                                        <span className="float-end"><b>980</b></span>
                                    </p>
                                </div>
                            </div>
                        </div>
                            ...
                            <div className="card mb-1">
                                <div className="card-body">
                                    ...
                                    <div className="d-flex align-items-center gap-2 my-3">
                                        ...
                                        <h3 className="mb-0">$<span data-target="17,854.22">0</span></h3>
                                        <span className="badge badge-soft-success fw-medium fs-xs ms-auto">+8.2%</span>
                                    </div>
                                    <p className="mb-0">
                                        <span className="text-success">
                                            <i className="ti ti-circle-filled align-middle"></i>
                                        </span>
                                        <span className="text-nowrap text-muted">Today's Sales</span>
                                        <span className="float-end"><b>$156K</b></span>
                                    </p>
                                </div>
                            </div>
                        </div>
                                ...
                                <div className="card-header border-light justify-content-between">
                                    <div className="d-flex gap-2">
                                        <div className="app-search">
                                            <input data-table-search type="search" className="form-control" placeholder="Search product name..." />
                                            <i className="ti ti-search app-search-icon text-muted"></i>
                                        </div>
                                    ...
                                    <div className="d-flex gap-1">
                                        <a href="apps-ecommerce-products-grid.html" className="btn btn-soft-primary btn-icon">
                                            <i className="ti ti-category fs-lg"></i>
                                        </a>
                                        <a href="apps-ecommerce-products.html" className="btn btn-soft-primary btn-icon active">
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <span className="ms-1">
                                                        <a data-sort="rating" href="apps-ecommerce-reviews.html" className="link-reset fw-semibold">(87)</a>
                                                    </span>
                                                </td>
                                                <td>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div className="d-flex">
                                                        ...
                                                        <div>
                                                            <h5 className="mb-1">
                                                                <a data-sort="product" href="apps-ecommerce-product-details.html" className="link-reset">Smart LED Desk Lamp</a>
                                                            </h5>
                                                            <p className="text-muted mb-0 fs-xxs">by: BrightLite</p>
                                                        </div>
                                                    </div>
                                                </td>
                                                <td>SL-89012</td>
                                                ...
                                                <td>
                                                    ...
                                                    <span className="ms-1">
                                                        <a data-sort="rating" href="apps-ecommerce-reviews.html" className="link-reset fw-semibold">(54)</a>
                                                    </span>
                                                </td>
                                                <td>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div className="d-flex">
                                                        ...
                                                        <div>
                                                            <h5 className="mb-1">
                                                                <a data-sort="product" href="apps-ecommerce-product-details.html" className="link-reset">Men's Running Shoes</a>
                                                            </h5>
                                                            <p className="text-muted mb-0 fs-xxs">by: ActiveWear Co.</p>
                                                        </div>
                                                    </div>
                                                </td>
                                                <td>RS-20450</td>
                                                ...
                                                <td>
                                                    ...
                                                    <span className="ms-1">
                                                        <a data-sort="rating" href="apps-ecommerce-reviews.html" className="link-reset fw-semibold">(142)</a>
                                                    </span>
                                                </td>
                                                <td>
                                                    <span className="badge badge-soft-success fs-xxs">Published</span>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div className="d-flex">
                                                        ...
                                                        <div>
                                                            <h5 className="mb-1">
                                                                <a data-sort="product" href="apps-ecommerce-product-details.html" className="link-reset">Fitness Tracker Watch</a>
                                                            </h5>
                                                            <p className="text-muted mb-0 fs-xxs">by: FitPulse</p>
                                                        </div>
                                                    </div>
                                                </td>
                                                <td>FT-67123</td>
                                                ...
                                                <td>
                                                    ...
                                                    <span className="ms-1">
                                                        <a data-sort="rating" href="apps-ecommerce-reviews.html" className="link-reset fw-semibold">(89)</a>
                                                    </span>
                                                </td>
                                                <td>
                                                    <span className="badge badge-soft-success fs-xxs">Published</span>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div className="d-flex">
                                                        ...
                                                        <div>
                                                            <h5 className="mb-1">
                                                                <a data-sort="product" href="apps-ecommerce-product-details.html" className="link-reset">Gaming Mouse RGB</a>
                                                            </h5>
                                                            <p className="text-muted mb-0 fs-xxs">by: HyperClick</p>
                                                        </div>
                                                    </div>
                                                </td>
                                                <td>GM-72109</td>
                                                ...
                                                <td>
                                                    ...
                                                    <span className="ms-1">
                                                        <a data-sort="rating" href="apps-ecommerce-reviews.html" className="link-reset fw-semibold">(102)</a>
                                                    </span>
                                                </td>
                                                <td>
                                                    <span className="badge badge-soft-success fs-xxs">Published</span>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div className="d-flex">
                                                        ...
                                                        <div>
                                                            <h5 className="mb-1">
                                                                <a data-sort="product" href="apps-ecommerce-product-details.html" className="link-reset">Modern Lounge Chair</a>
                                                            </h5>
                                                            <p className="text-muted mb-0 fs-xxs">by: UrbanLiving</p>
                                                        </div>
                                                    </div>
                                                </td>
                                                <td>FC-31220</td>
                                                ...
                                                <td>
                                                    ...
                                                    <span className="ms-1">
                                                        <a data-sort="rating" href="apps-ecommerce-reviews.html" className="link-reset fw-semibold">(27)</a>
                                                    </span>
                                                </td>
                                                <td>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div className="d-flex">
                                                        ...
                                                        <div>
                                                            <h5 className="mb-1">
                                                                <a data-sort="product" href="apps-ecommerce-product-details.html" className="link-reset">Plush Toy Bear</a>
                                                            </h5>
                                                            <p className="text-muted mb-0 fs-xxs">by: Softies</p>
                                                        </div>
                                                    </div>
                                                </td>
                                                <td>TY-00788</td>
                                                ...
                                                <td>
                                                    ...
                                                    <span className="ms-1">
                                                        <a data-sort="rating" href="apps-ecommerce-reviews.html" className="link-reset fw-semibold">(120)</a>
                                                    </span>
                                                </td>
                                                <td>
                                                    <span className="badge badge-soft-success fs-xxs">Published</span>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div className="d-flex">
                                                        ...
                                                        <div>
                                                            <h5 className="mb-1">
                                                                <a data-sort="product" href="apps-ecommerce-product-details.html" className="link-reset">55" Ultra HD Smart TV</a>
                                                            </h5>
                                                            <p className="text-muted mb-0 fs-xxs">by: ViewMaster</p>
                                                        </div>
                                                    </div>
                                                </td>
                                                <td>TV-5588</td>
                                                ...
                                                <td>
                                                    ...
                                                    <span className="ms-1">
                                                        <a data-sort="rating" href="apps-ecommerce-reviews.html" className="link-reset fw-semibold">(88)</a>
                                                    </span>
                                                </td>
                                                <td>
                                                    <span className="badge badge-soft-success fs-xxs">Published</span>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div className="d-flex">
                                                        ...
                                                        <div>
                                                            <h5 className="mb-1">
                                                                <a data-sort="product" href="apps-ecommerce-product-details.html" className="link-reset">Apple iMac 24" M3</a>
                                                            </h5>
                                                            <p className="text-muted mb-0 fs-xxs">by: Apple</p>
                                                        </div>
                                                    </div>
                                                </td>
                                                <td>IMAC-M3-24</td>
                                                ...
                                                <td>
                                                    ...
                                                    <span className="ms-1">
                                                        <a data-sort="rating" href="apps-ecommerce-reviews.html" className="link-reset fw-semibold">(16)</a>
                                                    </span>
                                                </td>
                                                <td>
                                                    <span className="badge badge-soft-warning fs-xxs">Pending</span>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div className="d-flex">
                                                        ...
                                                        <div>
                                                            <h5 className="mb-1">
                                                                <a data-sort="product" href="apps-ecommerce-product-details.html" className="link-reset">Smart Watch Pro X2</a>
                                                            </h5>
                                                            <p className="text-muted mb-0 fs-xxs">by: FitTech</p>
                                                        </div>
                                                    </div>
                                                </td>
                                                <td>SWPX2-GL</td>
                                                ...
                                                <td>
                                                    ...
                                                    <span className="ms-1">
                                                        <a data-sort="rating" href="apps-ecommerce-reviews.html" className="link-reset fw-semibold">(65)</a>
                                                    </span>
                                                </td>
                                                <td>
                                                    <span className="badge badge-soft-success fs-xxs">Published</span>
