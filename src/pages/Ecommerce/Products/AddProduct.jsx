                    ...
                    <div className="row">
                        <div className="col-xxl-12">
                            <div className="row">
                                        ...
                                        <div className="card-body">
                                            <div className="row">
                                                <div className="col-12">
                                                    <div className="mb-3">
                                                        <label for="productName" className="form-label">Product Name <span className="text-danger">*</span></label>
                                                ...
                                                <div className="col-lg-6">
                                                    <div className="mb-3">
                                                        <label for="skuId" className="form-label">SKU <span className="text-danger">*</span></label>
                                                        <input type="text" className="form-control" id="skuId" placeholder="SOFA-10058" required="" />
                                                    </div>
                                                </div>
                                                <div className="col-lg-6">
                                                    <div className="mb-3">
                                                        <label for="stockNumber" className="form-label">Stock <span className="text-danger">*</span></label>
                                                        <input type="number" className="form-control" id="stockNumber" placeholder="250" />
                                                    </div>
                                                </div>

                                                <div className="col-12">
                                                    <div>
                                                        <label className="form-label">Product Description <span className="text-muted">(Optional)</span></label>
                                                        <div id="snow-editor">
                                                            <p>
                                                ...
                                                <div className="col-12">
                                                    <form action="https://coderthemes.com/" method="post" className="dropzone" id="myAwesomeDropzone" data-plugin="dropzone" data-previews-container="#file-previews" data-upload-preview-template="#uploadPreviewTemplate">
                                                        ...
                                                        <div className="dz-message needsclick">
                                                            ...
                                                            <button type="button" className="btn btn-sm shadow btn-default">Browse Images</button>
                                                        </div>
                                                    </form>
                                ...
                                <div className="col-xxl-4">
                                    <div className="card">
                                        ...
                                        <div className="card-body">
                                            <div className="mb-3">
                                                <label for="basePrice" className="form-label">Base Price <span className="text-danger">*</span></label>
                                                <div className="app-search">
                                                    <input type="number" className="form-control" id="basePrice" placeholder="Enter base price (e.g., 199.99)" />
                                                    <i className="ti ti-currency-dollar app-search-icon text-muted"></i>
                                                </div>
                                            </div>

                                            <div className="mb-3">
                                                <label for="discount" className="form-label">Discount Type <span className="text-muted">(Optional)</span></label>
                                                <div className="app-search">
                                                    <select className="form-select form-control my-1 my-md-0" id="discount">
                                            ...
                                            <div className="mb-0">
                                                <label for="discountValue" className="form-label">Discount Value <span className="text-muted">(Optional)</span></label>
                                                <div className="app-search">
                                                    <input type="number" className="form-control" id="discountValue" placeholder="Enter discount amount or percentage" />
                                    ...
                                    <div className="card">
                                        ...
                                        <div className="card-body">
                                            ...
                                            <div className="mb-3">
                                                <label for="category" className="form-label">Category <span className="text-danger">*</span></label>
                                                <div className="app-search">
                                                    <select className="form-select form-control my-1 my-md-0" id="category">
                                            ...
                                            <div className="mb-3">
                                                <label for="subCategory" className="form-label">Sub Category <span className="text-danger">*</span></label>
                                                <div className="app-search">
                                                    <select className="form-select form-control my-1 my-md-0" id="subCategory">
                                            ...
                                            <div className="mb-3">
                                                <label for="statusOne" className="form-label">Status <span className="text-danger">*</span></label>
                                                <div className="app-search">
                                                    <select className="form-select form-control my-1 my-md-0" id="statusOne">
                                            ...
                                            <div className="mb-0">
                                                ...
                                                <div className="app-search">
                                                    <input type="text" className="form-control" id="tags" placeholder="Enter tags separated by commas" />
                                                    <i className="ti ti-tag app-search-icon text-muted"></i>
                                                </div>
                                            </div>
                                        </div>
                            ...
                            <div className="mt-2 mb-4 d-flex gap-2 justify-content-center">
                                ...
                                <a href="#!" className="btn btn-secondary"> Save as Draft </a>
                                <a href="#!" className="btn btn-success"> Publish </a>
                            </div>
                        </div>
                    </div>
                </div>
...
<script src="assets/js/app.js"></script>
        ...
        <script src="assets/js/pages/ecommerce-product-add.js"></script>
    </div>
  )
}
