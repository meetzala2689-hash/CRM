                                                    ...
                                                    <div id="carouselExampleFade" className="carousel slide carousel-fade" data-bs-ride="carousel">
                                                        <div className="carousel-inner" role="listbox">
                                                            <div className="carousel-item text-center active">
                                                                <img src="assets/images/products/single-1.png" alt="" className="img-fluid" />
                                                            </div>
                                                            <div className="carousel-item text-center">
                                                                <img src="assets/images/products/single-2.png" alt="" className="img-fluid" />
                                                            </div>
                                                            <div className="carousel-item text-center">
                                                                <img src="assets/images/products/single-3.png" alt="" className="img-fluid" />
                                                            </div>
                                                            <div className="carousel-item text-center">
                                                                <img src="assets/images/products/single-4.png" alt="" className="img-fluid" />
                                                            </div>
                                                        </div>
                                                        <div className="carousel-indicators m-0 mt-3 d-lg-flex d-none position-static h-100 rounded gap-2">
                                                            <button type="button" data-bs-target="#carouselExampleFade" data-bs-slide-to="0" aria-current="true" aria-label="Slide 1" className="h-auto rounded bg-light-subtle border active" style="width: auto !important">
                                                                <img src="assets/images/products/single-1.png" className="d-block avatar-xl" alt="indicator-img" />
                                                            </button>
                                                            <button type="button" data-bs-target="#carouselExampleFade" data-bs-slide-to="1" aria-label="Slide 2" className="h-auto rounded bg-light-subtle border" style="width: auto !important">
                                                                <img src="assets/images/products/single-2.png" className="d-block avatar-xl" alt="indicator-img" />
                                                            </button>
                                                            <button type="button" data-bs-target="#carouselExampleFade" data-bs-slide-to="2" aria-label="Slide 3" className="h-auto rounded bg-light-subtle border" style="width: auto !important">
                                                                <img src="assets/images/products/single-3.png" className="d-block avatar-xl" alt="indicator-img" />
                                                            </button>
                                                            <button type="button" data-bs-target="#carouselExampleFade" data-bs-slide-to="3" aria-label="Slide 4" className="h-auto rounded bg-light-subtle border" style="width: auto !important">
                                                                <img src="assets/images/products/single-4.png" className="d-block avatar-xl" alt="indicator-img" />
                                                            </button>
                                                        </div>
                                                    </div>
                                            ...
                                            <div className="p-4">
                                                ...
                                                <div className="row mb-4">
                                                    <div className="col-md-4 col-xl-3">
                                                        <h6 className="mb-1 text-muted text-uppercase">SKU:</h6>
                                                        <p className="fw-medium mb-0">IMAC-M3-24</p>
                                                    </div>
                                                    <div className="col-md-4 col-xl-3">
                                                        <h6 className="mb-1 text-muted text-uppercase">Category:</h6>
                                                        <p className="fw-medium mb-0">Computers</p>
                                                    </div>
                                                    <div className="col-md-4 col-xl-3">
                                                        <h6 className="mb-1 text-muted text-uppercase">Stock:</h6>
                                                        <p className="fw-medium mb-0">67</p>
                                                    </div>
                                                    <div className="col-md-4 col-xl-3">
                                                        <h6 className="mb-1 text-muted text-uppercase">Published:</h6>
                                                        <p className="fw-medium mb-0">12 Jul, 2025 <small className="text-muted">09:00 AM</small></p>
                                                    </div>
                                                </div>

                                                <div className="row mb-4">
                                                    <div className="col-md-4 col-xl-3">
                                                        <h6 className="mb-1 text-muted text-uppercase">Orders:</h6>
                                                        <p className="fw-medium mb-0">1,428</p>
                                                    </div>
                                                    <div className="col-md-4 col-xl-3">
                                                        <h6 className="mb-1 text-muted text-uppercase">Revenue:</h6>
                                                        <p className="fw-medium mb-0">$2,350,120.00</p>
                                                    </div>
                                                </div>
                                                ...
                                                <div data-table data-table-rows-per-page="5" className="card mt-5 shadow-none border border-dashed">
                                                            ...
                                                            <div className="col-xl-7">
                                                                <div className="d-flex align-items-center gap-4 p-4">
                                                                    ...
                                                                    <div>
                                                                        ...
                                                                        <span className="badge badge-label text-bg-success">+12 new this week</span>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            <div className="col-xl-5">
                                                                <div className="p-3">
                                                                    <div className="d-flex align-items-center gap-2 mb-2">
                                                                        ...
                                                                        <div className="flex-shrink-0 text-end" style="width: 30px">
                                                                            <span className="badge text-bg-light">128</span>
                                                                        </div>
                                                                    </div>
                                                                    ...
                                                                    <div className="d-flex align-items-center gap-2 mb-2">
                                                                        ...
                                                                        <div className="flex-shrink-0 text-end" style="width: 30px">
                                                                            <span className="badge text-bg-light">37</span>
                                                                        </div>
                                                                    </div>
                                                                    ...
                                                                    <div className="d-flex align-items-center gap-2 mb-2">
                                                                        ...
                                                                        <div className="flex-shrink-0 text-end" style="width: 30px">
                                                                            <span className="badge text-bg-light">15</span>
                                                                        </div>
                                                                    </div>
                                                                    ...
                                                                    <div className="d-flex align-items-center gap-2">
                                                                        ...
                                                                        <div className="flex-shrink-0 text-end" style="width: 30px">
                                                                            <span className="badge text-bg-light">2</span>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                                ...
                                                                <tr>
                                                                    <td>
                                                                        <div className="d-flex justify-content-start align-items-center gap-2">
                                                                            ...
                                                                            <div>
                                                                                <h5 className="text-nowrap fs-sm mb-0 lh-base">Sophia Lee</h5>
                                                                    ...
                                                                    <td>
                                                                        22 Apr, 2025
                                                                        <small className="text-muted">04:10 PM</small>
                                                                    </td>
                                                                    <td>
                                                                ...
                                                                <tr>
                                                                    <td>
                                                                        <div className="d-flex justify-content-start align-items-center gap-2">
                                                                            ...
                                                                            <div>
                                                                                <h5 className="text-nowrap fs-sm mb-0 lh-base">David Smith</h5>
                                                                    ...
                                                                    <td>
                                                                        23 Apr, 2025
                                                                        <small className="text-muted">02:20 PM</small>
                                                                    </td>
                                                                    <td>
                                                                ...
                                                                <tr>
                                                                    <td>
                                                                        <div className="d-flex justify-content-start align-items-center gap-2">
                                                                            ...
                                                                            <div>
                                                                                <h5 className="text-nowrap fs-sm mb-0 lh-base">Alice Johnson</h5>
                                                                ...
                                                                <tr>
                                                                    <td>
                                                                        <div className="d-flex justify-content-start align-items-center gap-2">
                                                                            ...
                                                                            <div>
                                                                                <h5 className="text-nowrap fs-sm mb-0 lh-base">Michael Green</h5>
                                                                ...
                                                                <tr>
                                                                    <td>
                                                                        <div className="d-flex justify-content-start align-items-center gap-2">
                                                                            ...
                                                                            <div>
                                                                                <h5 className="text-nowrap fs-sm mb-0 lh-base">Chris Evans</h5>
