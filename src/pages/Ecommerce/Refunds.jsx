                ...
                <div className="container-fluid">
                    <div className="page-title-head d-flex align-items-center">
                        <div className="flex-grow-1">
                            <h4 className="page-main-title m-0">Refunds</h4>
                        </div>
                                    ...
                                    <div className="d-flex align-items-center gap-2 mb-3">
                                        <div className="avatar-md flex-shrink-0">
                                            <span className="avatar-title text-bg-primary rounded-circle fs-22">
                                                <i className="ti ti-credit-card-refund"></i>
                                            </span>
                                        </div>
                                        <h3 className="mb-0">2,310</h3>
                                    </div>
                                    <p className="mb-0">
                                        Total Refund Requests
                                        <span className="float-end badge badge-soft-primary">+5.42%</span>
                                    </p>
                                </div>
                            </div>
                        </div>
                            ...
                            <div className="card mb-1">
                                <div className="card-body">
                                    <div className="d-flex align-items-center gap-2 mb-3">
                                        ...
                                        <h3 className="mb-0">1,560</h3>
                                    </div>
                                    <p className="mb-0">
                                        Approved Refunds
                                        <span className="float-end badge badge-soft-success">+3.18%</span>
                                    </p>
                                </div>
                            </div>
                        </div>
                                    ...
                                    <div className="d-flex align-items-center gap-2 mb-3">
                                        <div className="avatar-md flex-shrink-0">
                                            <span className="avatar-title text-bg-warning rounded-circle fs-22">
                                                <i className="ti ti-alarm-snooze"></i>
                                            </span>
                                        </div>
                                        <h3 className="mb-0">430</h3>
                                    </div>
                                    <p className="mb-0">
                                        Pending Refunds
                                        <span className="float-end badge badge-soft-warning">-1.09%</span>
                                    </p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="col">
                            <div className="card mb-1">
                                <div className="card-body">
                                    ...
                                    <p className="mb-0">
                                        Rejected Refunds
                                        <span className="float-end badge badge-soft-danger">-0.62%</span>
                                    </p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="col">
                            <div className="card mb-1">
                                <div className="card-body">
                                    ...
                                    <p className="mb-0">
                                        Fully Refunded
                                        <span className="float-end badge badge-soft-info">+2.41%</span>
                                    </p>
                                </div>
                            </div>
                        </div>
                                ...
                                <div className="card-header border-light justify-content-between">
                                    <div className="d-flex gap-2">
                                        <div className="app-search">
                                            <input data-table-search type="search" className="form-control" placeholder="Search refunds..." />
                                            <i className="ti ti-search app-search-icon text-muted"></i>
                                        </div>
                                    ...
                                    <div className="d-flex align-items-center gap-2 flex-wrap">
                                        ...
                                        <div className="app-search">
                                            <select data-table-filter="refund-status" className="form-select form-control my-1 my-md-0">
                                            ...
                                            <i className="ti ti-credit-card-refund app-search-icon text-muted"></i>
                                        </div>
                                    ...
                                    <div className="d-flex gap-1">
                                        <a href="#createRefundModal" className="btn btn-primary ms-1" data-bs-toggle="modal"> <i className="ti ti-plus fs-sm me-2"></i> Create Refund </a>
                                    </div>
                                </div>
                                    ...
                                    <table className="table table-custom table-centered table-select table-hover w-100 mb-0">
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td>
                                                    <h5 className="fs-sm mb-0"><a href="apps-ecommerce-order-details.html" className="link-reset">#INV-10423</a></h5>
                                                </td>
                                                <td>
                                                    <div className="d-flex align-items-center gap-2">
                                                        <img src="assets/images/products/1.png" alt="" className="rounded" width="34" height="34" />
                                                        <div>
                                                            <div className="fw-medium">NoiseCancel Headphones</div>
                                                            <small className="text-muted">SKU: NC-900</small>
                                                        </div>
                                                    </div>
                                                </td>
                                                <td>
                                                    <div className="d-flex justify-content-start align-items-center gap-2">
                                                        ...
                                                        <div>
                                                            <h5 data-sort="customer" className="text-nowrap fs-base mb-0 lh-base">Mason Carter</h5>
                                                            <p className="text-muted fs-xs mb-0">mason.carter&#64;shopmail.com</p>
                                                        </div>
                                                    </div>
                                                </td>
                                                <td>Damaged on arrival</td>
                                                <td><img src="assets/images/cards/visa.svg" alt="" className="me-2" height="28" /> xxxx 7832</td>
                                                <td>$129.45</td>
                                                <td>
                                                    <span className="badge badge-label badge-soft-warning">Pending</span>
                                                </td>
                                                <td><span className="text-nowrap">08 Oct 2025</span></td>
                                                <td>-</td>
                                                <td>
                                                    <div className="d-flex justify-content-center gap-1">
                                                        <a href="#!" className="btn btn-default btn-icon btn-sm"><i className="ti ti-check fs-lg"></i></a>
                                                        <a href="#!" className="btn btn-default btn-icon btn-sm"><i className="ti ti-x fs-lg"></i></a>
                                                        <a href="#" data-table-delete-row className="btn btn-default btn-icon btn-sm"><i className="ti ti-trash fs-lg"></i></a>
                                                        <button className="btn btn-default btn-icon btn-sm dropdown-toggle drop-arrow-none" data-bs-toggle="dropdown"><i className="ti ti-dots-vertical fs-lg"></i></button>
                                                        <ul className="dropdown-menu dropdown-menu-end">
                                                            <li><a className="dropdown-item" href="#">View order</a></li>
                                                            <li><a className="dropdown-item" href="#">Contact customer</a></li>
                                                            <li>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <h5 className="fs-sm mb-0"><a href="apps-ecommerce-order-details.html" className="link-reset">#INV-10407</a></h5>
                                                </td>
                                                <td>
                                                    <div className="d-flex align-items-center gap-2">
                                                        <img src="assets/images/products/2.png" alt="" className="rounded" width="34" height="34" />
                                                        <div>
                                                            <div className="fw-medium">Smartwatch Pro</div>
                                                            <small className="text-muted">SKU: SW-PRO</small>
                                                        </div>
                                                    </div>
                                                </td>
                                                <td>
                                                    <div className="d-flex justify-content-start align-items-center gap-2">
                                                        ...
                                                        <div>
                                                            <h5 className="text-nowrap fs-base mb-0 lh-base">Sofia Williams</h5>
                                                            <p className="text-muted fs-xs mb-0">sofia.williams&#64;shopmail.com</p>
                                                        </div>
                                                    </div>
                                                </td>
                                                <td>Wrong size received</td>
                                                <td><img src="assets/images/cards/mastercard.svg" alt="" className="me-2" height="28" /> xxxx 2294</td>
                                                <td>$79.99</td>
                                                <td><span className="badge badge-label badge-soft-success">Approved</span></td>
                                                <td><span className="text-nowrap">05 Oct 2025</span></td>
                                                <td><span className="text-nowrap">06 Oct 2025</span></td>
                                                <td>
                                                    <div className="d-flex justify-content-center gap-1">
                                                        <a href="#!" className="btn btn-default btn-icon btn-sm"><i className="ti ti-check fs-lg"></i></a>
                                                        <a href="#!" className="btn btn-default btn-icon btn-sm"><i className="ti ti-x fs-lg"></i></a>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <h5 className="fs-sm mb-0"><a href="apps-ecommerce-order-details.html" className="link-reset">#INV-10388</a></h5>
                                                </td>
                                                <td>
                                                    <div className="d-flex align-items-center gap-2">
                                                        <img src="assets/images/products/3.png" alt="" className="rounded" width="34" height="34" />
                                                        <div>
                                                            <div className="fw-medium">4K Action Camera</div>
                                                            <small className="text-muted">SKU: AC-4K</small>
                                                        </div>
                                                    </div>
                                                </td>
                                                <td>
                                                    <div className="d-flex justify-content-start align-items-center gap-2">
                                                        ...
                                                        <div>
                                                            <h5 className="text-nowrap fs-base mb-0 lh-base">Liam Brown</h5>
                                                            <p className="text-muted fs-xs mb-0">liam.brown&#64;shopmail.com</p>
                                                        </div>
                                                    </div>
                                                </td>
                                                <td>No longer needed</td>
                                                <td><img src="assets/images/cards/american-express.svg" alt="" className="me-2" height="28" /> xxxx 1145</td>
                                                <td>$249.00</td>
                                                <td><span className="badge badge-label badge-soft-secondary">Refunded</span></td>
                                                <td><span className="text-nowrap">30 Sep 2025</span></td>
                                                <td><span className="text-nowrap">01 Oct 2025</span></td>
                                                <td>
                                                    <div className="d-flex justify-content-center gap-1">
                                                        <a href="#!" className="btn btn-default btn-icon btn-sm"><i className="ti ti-check fs-lg"></i></a>
                                                        <a href="#!" className="btn btn-default btn-icon btn-sm"><i className="ti ti-x fs-lg"></i></a>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <h5 className="fs-sm mb-0"><a href="apps-ecommerce-order-details.html" className="link-reset">#INV-10352</a></h5>
                                                </td>
                                                <td>
                                                    <div className="d-flex align-items-center gap-2">
                                                        <img src="assets/images/products/4.png" alt="" className="rounded" width="34" height="34" />
                                                        <div>
                                                            <div className="fw-medium">Bluetooth Speaker Mini</div>
                                                            <small className="text-muted">SKU: BS-MINI</small>
                                                        </div>
                                                    </div>
                                                </td>
                                                <td>
                                                    <div className="d-flex justify-content-start align-items-center gap-2">
                                                        ...
                                                        <div>
                                                            <h5 className="text-nowrap fs-base mb-0 lh-base">Emma Johnson</h5>
                                                            <p className="text-muted fs-xs mb-0">emma.johnson&#64;shopmail.com</p>
                                                        </div>
                                                    </div>
                                                </td>
                                                <td>Product not as described</td>
                                                <td><img src="assets/images/cards/paypal.svg" alt="" className="me-2" height="28" /> PayPal</td>
                                                <td>$59.99</td>
                                                <td><span className="badge badge-label badge-soft-danger">Rejected</span></td>
                                                <td><span className="text-nowrap">25 Sep 2025</span></td>
                                                <td>-</td>
                                                <td>
                                                    <div className="d-flex justify-content-center gap-1">
                                                        <a href="#!" className="btn btn-default btn-icon btn-sm"><i className="ti ti-check fs-lg"></i></a>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <h5 className="fs-sm mb-0"><a href="apps-ecommerce-order-details.html" className="link-reset">#INV-10341</a></h5>
                                                </td>
                                                <td>
                                                    <div className="d-flex align-items-center gap-2">
                                                        <img src="assets/images/products/5.png" alt="" className="rounded" width="34" height="34" />
                                                        <div>
                                                            <div className="fw-medium">Wireless Mouse</div>
                                                            <small className="text-muted">SKU: WM-450</small>
                                                        </div>
                                                    </div>
                                                </td>
                                                <td>
                                                    <div className="d-flex align-items-center gap-2">
                                                        ...
                                                        <div>
                                                            <h5 className="fs-base mb-0 lh-base">Oliver Garcia</h5>
                                                            <p className="text-muted fs-xs mb-0">oliver.garcia&#64;shopmail.com</p>
                                                        </div>
                                                    </div>
                                                </td>
                                                <td>Did not work as expected</td>
                                                <td><img src="assets/images/cards/visa.svg" alt="" className="me-2" height="28" /> xxxx 9821</td>
                                                <td>$39.00</td>
                                                <td><span className="badge badge-label badge-soft-warning">Pending</span></td>
                                                <td><span className="text-nowrap">22 Sep 2025</span></td>
                                                <td>-</td>
                                                <td>
                                                    <div className="d-flex justify-content-center gap-1">
                                                        <a href="#!" className="btn btn-default btn-icon btn-sm"><i className="ti ti-check fs-lg"></i></a>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <h5 className="fs-sm mb-0"><a href="#" className="link-reset">#INV-10322</a></h5>
                                                </td>
                                                <td>
                                                    <div className="d-flex align-items-center gap-2">
                                                        <img src="assets/images/products/6.png" alt="" className="rounded" width="34" height="34" />
                                                        <div>
                                                            <div className="fw-medium">Ergonomic Office Chair</div>
                                                            <small className="text-muted">SKU: CHR-550</small>
                                                        </div>
                                                    </div>
                                                </td>
                                                <td>
                                                    <div className="d-flex align-items-center gap-2">
                                                        ...
                                                        <div>
                                                            <h5 className="fs-base mb-0 lh-base">Lucas Turner</h5>
                                                            <p className="text-muted fs-xs mb-0">lucas.turner&#64;shopmail.com</p>
                                                        </div>
                                                    </div>
                                                </td>
                                                <td>Incorrect color delivered</td>
                                                <td><img src="assets/images/cards/american-express.svg" alt="" className="me-2" height="28" /> xxxx 6730</td>
                                                <td>$199.00</td>
                                                <td><span className="badge badge-label badge-soft-success">Approved</span></td>
                                                <td><span className="text-nowrap">20 Sep 2025</span></td>
                                                <td><span className="text-nowrap">21 Sep 2025</span></td>
                                                <td>
                                                    <div className="d-flex justify-content-center gap-1">
                                                        <a href="#!" className="btn btn-default btn-icon btn-sm"><i className="ti ti-check fs-lg"></i></a>
                                                        <a href="#!" className="btn btn-default btn-icon btn-sm"><i className="ti ti-x fs-lg"></i></a>
                                            ...
                                            <tr>
                                                <td className="ps-3"><input className="form-check-input form-check-input-light fs-14 product-item-check mt-0" type="checkbox" /></td>
                                                <td>
                                                    <h5 className="fs-sm mb-0"><a href="#" className="link-reset">#INV-10305</a></h5>
                                                </td>
                                                <td>
                                                    <div className="d-flex align-items-center gap-2">
                                                        <img src="assets/images/products/7.png" alt="" className="rounded" width="34" height="34" />
                                                        <div>
                                                            <div className="fw-medium">Portable Vacuum Cleaner</div>
                                                            <small className="text-muted">SKU: VC-201</small>
                                                        </div>
                                                    </div>
                                                </td>
                                                <td>
                                                    <div className="d-flex align-items-center gap-2">
                                                        ...
                                                        <div>
                                                            <h5 className="fs-base mb-0 lh-base">Charlotte Davis</h5>
                                                            <p className="text-muted fs-xs mb-0">charlotte.d&#64;shopmail.com</p>
                                                        </div>
                                                    </div>
                                                </td>
                                                <td>Missing accessories</td>
                                                <td><img src="assets/images/cards/mastercard.svg" alt="" className="me-2" height="28" /> xxxx 8142</td>
                                                <td>$89.50</td>
                                                <td><span className="badge badge-label badge-soft-secondary">Refunded</span></td>
                                                <td><span className="text-nowrap">16 Sep 2025</span></td>
                                                <td><span className="text-nowrap">18 Sep 2025</span></td>
                                                <td>
                                                    <div className="d-flex justify-content-center gap-1">
                                                        <a href="#!" className="btn btn-default btn-icon btn-sm"><i className="ti ti-check fs-lg"></i></a>
                                                        <a href="#!" className="btn btn-default btn-icon btn-sm"><i className="ti ti-x fs-lg"></i></a>
                                            ...
                                            <tr>
                                                <td className="ps-3"><input className="form-check-input form-check-input-light fs-14 product-item-check mt-0" type="checkbox" /></td>
                                                <td>
                                                    <h5 className="fs-sm mb-0"><a href="#" className="link-reset">#INV-10293</a></h5>
                                                </td>
                                                <td>
                                                    <div className="d-flex align-items-center gap-2">
                                                        <img src="assets/images/products/8.png" alt="" className="rounded" width="34" height="34" />
                                                        <div>
                                                            <div className="fw-medium">Gaming Keyboard RGB</div>
                                                            <small className="text-muted">SKU: GK-88</small>
                                                        </div>
                                                    </div>
                                                </td>
                                                <td>
                                                    <div className="d-flex align-items-center gap-2">
                                                        ...
                                                        <div>
                                                            <h5 className="fs-base mb-0 lh-base">Henry Martin</h5>
                                                            <p className="text-muted fs-xs mb-0">henry.martin&#64;shopmail.com</p>
                                                        </div>
                                                    </div>
                                                </td>
                                                ...
                                                <td>$119.00</td>
                                                <td><span className="badge badge-label badge-soft-danger">Rejected</span></td>
                                                <td><span className="text-nowrap">12 Sep 2025</span></td>
                                                <td>-</td>
                                                <td>
                                                    <div className="d-flex justify-content-center gap-1">
                                                        <a href="#!" className="btn btn-default btn-icon btn-sm"><i className="ti ti-check fs-lg"></i></a>
                                            ...
                                            <tr>
                                                <td className="ps-3"><input className="form-check-input form-check-input-light fs-14 product-item-check mt-0" type="checkbox" /></td>
                                                <td>
                                                    <h5 className="fs-sm mb-0"><a href="#" className="link-reset">#INV-10275</a></h5>
                                                </td>
                                                <td>
                                                    <div className="d-flex align-items-center gap-2">
                                                        <img src="assets/images/products/9.png" alt="" className="rounded" width="34" height="34" />
                                                        <div>
                                                            <div className="fw-medium">Fitness Tracker Band</div>
                                                            <small className="text-muted">SKU: FT-900</small>
                                                        </div>
                                                    </div>
                                                </td>
                                                <td>
                                                    <div className="d-flex align-items-center gap-2">
                                                        <div className="avatar avatar-sm">
                                                            <img src="assets/images/users/user-3.jpg" alt="avatar-11" className="img-fluid rounded-circle" />
                                                        </div>
                                                        <div>
                                                            <h5 className="fs-base mb-0 lh-base">Ella Rodriguez</h5>
                                                            <p className="text-muted fs-xs mb-0">ella.rodriguez&#64;shopmail.com</p>
                                                        </div>
                                                    </div>
                                                </td>
                                                <td>Did not sync with app</td>
                                                <td><img src="assets/images/cards/visa.svg" alt="" className="me-2" height="28" /> xxxx 9082</td>
                                                <td>$49.99</td>
                                                <td><span className="badge badge-label badge-soft-warning">Pending</span></td>
                                                <td><span className="text-nowrap">08 Sep 2025</span></td>
                                                <td>-</td>
                                                <td>
                                                    <div className="d-flex justify-content-center gap-1">
                                                        <a href="#!" className="btn btn-default btn-icon btn-sm"><i className="ti ti-check fs-lg"></i></a>
                                            ...
                                            <tr>
                                                <td className="ps-3"><input className="form-check-input form-check-input-light fs-14 product-item-check mt-0" type="checkbox" /></td>
                                                <td>
                                                    <h5 className="fs-sm mb-0"><a href="#" className="link-reset">#INV-10261</a></h5>
                                                </td>
                                                <td>
                                                    <div className="d-flex align-items-center gap-2">
                                                        <img src="assets/images/products/10.png" alt="" className="rounded" width="34" height="34" />
                                                        <div>
                                                            <div className="fw-medium">Laptop Stand Adjustable</div>
                                                            <small className="text-muted">SKU: LS-101</small>
                                                        </div>
                                                    </div>
                                                </td>
                                                <td>
                                                    <div className="d-flex align-items-center gap-2">
                                                        <div className="avatar avatar-sm">
                                                            <img src="assets/images/users/user-2.jpg" alt="avatar-12" className="img-fluid rounded-circle" />
                                                        </div>
                                                        <div>
                                                            <h5 className="fs-base mb-0 lh-base">James Anderson</h5>
                                                            <p className="text-muted fs-xs mb-0">james.anderson&#64;shopmail.com</p>
                                                        </div>
                                                    </div>
                                                </td>
                                                <td>Package arrived late</td>
                                                <td><img src="assets/images/cards/mastercard.svg" alt="" className="me-2" height="28" /> xxxx 3210</td>
                                                <td>$64.99</td>
                                                <td><span className="badge badge-label badge-soft-success">Approved</span></td>
                                                <td><span className="text-nowrap">05 Sep 2025</span></td>
                                                <td><span className="text-nowrap">06 Sep 2025</span></td>
                                                <td>
                                                    <div className="d-flex justify-content-center gap-1">
                                                        <a href="#!" className="btn btn-default btn-icon btn-sm"><i className="ti ti-check fs-lg"></i></a>
                                                        <a href="#!" className="btn btn-default btn-icon btn-sm"><i className="ti ti-x fs-lg"></i></a>
                    ...
                    <div className="modal fade" id="createRefundModal" tabindex="-1" aria-labelledby="createRefundModalLabel" aria-hidden="true">
                        <div className="modal-dialog modal-dialog-centered">
                            <div className="modal-content">
                                <div className="modal-header">
                                    <h5 className="modal-title fw-semibold" id="createRefundModalLabel"><i className="ti ti-credit-card me-2 text-primary"></i> Create Refund</h5>
                                ...
                                <form action="#!" method="post">
                                    <div className="modal-body">
                                        ...
                                        <div className="mb-3">
                                            <label for="refundOrderId" className="form-label fw-semibold">Order ID</label>
                                        ...
                                        <div className="mb-3">
                                            <label for="refundCustomer" className="form-label fw-semibold">Customer</label>
                                            <input id="refundCustomer" type="text" className="form-control" value="Mason Carter" readonly />
                                        </div>

                                        <div className="mb-3">
                                            <label for="refundReason" className="form-label fw-semibold">Reason</label>
                                            <textarea id="refundReason" className="form-control" rows="2" placeholder="Enter refund reason (e.g., damaged item, wrong product, etc.)"></textarea>
                                        </div>

                                        <div className="mb-3">
                                            <label for="refundMethod" className="form-label fw-semibold">Refund Method</label>
                                        ...
                                        <div className="mb-3">
                                            <label for="refundAmount" className="form-label fw-semibold">Refund Amount</label>
                                            <div className="input-group">
                                                <span className="input-group-text">$</span>
                                                <input id="refundAmount" type="number" className="form-control" placeholder="129.45" value="129.45" />
                                            </div>
                                        </div>

                                        <div>
                                            <label for="refundDate" className="form-label fw-semibold">Refund Date</label>
                                            <input id="refundDate" type="date" className="form-control" data-provider="flatpickr" data-date-format="d M, Y" value="2025-10-08" />
                                        </div>
                                    </div>

                                    <div className="modal-footer">
                                        <button type="button" className="btn btn-light" data-bs-dismiss="modal">Cancel</button>
                                        <button type="submit" className="btn btn-primary"><i className="ti ti-check me-1"></i> Confirm Refund</button>
                                    </div>
                                </form>
                            </div>
                        </div>
