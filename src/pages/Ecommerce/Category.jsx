                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div className="d-flex align-items-center">
                                                        ...
                                                        <div>
                                                            <h5 className="mb-0">
                                                                <a data-sort="product" href="#!" className="link-reset">Furnitures</a>
                                                            </h5>
                                                        </div>
                                                    </div>
                                                </td>
                                                ...
                                                <td>95.6k</td>
                                                <td>$40.5M</td>
                                                <td>18 Apr, 2025 <small className="text-muted">12:24 PM</small></td>
                                                <td><span className="badge badge-soft-success fs-xxs">Active</span></td>
                                                <td>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div className="d-flex align-items-center">
                                                        ...
                                                        <div>
                                                            <h5 className="mb-0">
                                                                <a data-sort="product" href="#!" className="link-reset">Electronics</a>
                                                            </h5>
                                                        </div>
                                                    </div>
                                                </td>
                                                <td>electronics</td>
                                                <td>
                                                    <h5 className="fs-base mb-0 fw-medium">9854</h5>
                                                </td>
                                                <td>112.3k</td>
                                                <td>$30.4M</td>
                                                <td>20 Apr, 2025 <small className="text-muted">09:10 AM</small></td>
                                                <td><span className="badge badge-soft-success fs-xxs">Active</span></td>
                                                <td>
                                                    <div className="d-flex justify-content-center gap-1">
                                                        <a href="#" className="btn btn-default btn-icon btn-sm"><i className="ti ti-eye fs-lg"></i></a>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div className="d-flex align-items-center">
                                                        ...
                                                        <div>
                                                            <h5 className="mb-0">
                                                                <a data-sort="product" href="#!" className="link-reset">Smartphones</a>
                                                            </h5>
                                                        </div>
                                                    </div>
                                                </td>
                                                ...
                                                <td>
                                                    <h5 className="fs-base mb-0 fw-medium">1324</h5>
                                                </td>
                                                <td>50.1k</td>
                                                <td>$22.3M</td>
                                                <td>22 Apr, 2025 <small className="text-muted">11:45 AM</small></td>
                                                <td><span className="badge badge-soft-danger fs-xxs">Inactive</span></td>
                                                <td>
                                                    <div className="d-flex justify-content-center gap-1">
                                                        <a href="#" className="btn btn-default btn-icon btn-sm"><i className="ti ti-eye fs-lg"></i></a>
                                                        <a href="#" className="btn btn-default btn-icon btn-sm"><i className="ti ti-edit fs-lg"></i></a>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div className="d-flex align-items-center">
                                                        ...
                                                        <div>
                                                            <h5 className="mb-0">
                                                                <a data-sort="product" href="#!" className="link-reset">Headphones</a>
                                                            </h5>
                                                        </div>
                                                    </div>
                                                </td>
                                                <td>accessories</td>
                                                <td>
                                                    <h5 className="fs-base mb-0 fw-medium">5123</h5>
                                                </td>
                                                <td>70.8k</td>
                                                <td>$5.7M</td>
                                                <td>25 Apr, 2025 <small className="text-muted">08:20 AM</small></td>
                                                <td><span className="badge badge-soft-success fs-xxs">Active</span></td>
                                                <td>
                                                    <div className="d-flex justify-content-center gap-1">
                                                        <a href="#" className="btn btn-default btn-icon btn-sm"><i className="ti ti-eye fs-lg"></i></a>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div className="d-flex align-items-center">
                                                        ...
                                                        <div>
                                                            <h5 className="mb-0">
                                                                <a data-sort="product" href="#!" className="link-reset">Table Lamps</a>
                                                            </h5>
                                                        </div>
                                                    </div>
                                                </td>
                                                ...
                                                <td>
                                                    <h5 className="fs-base mb-0 fw-medium">7589</h5>
                                                </td>
                                                <td>88.7k</td>
                                                <td>$13.2M</td>
                                                <td>27 Apr, 2025 <small className="text-muted">03:15 PM</small></td>
                                                <td><span className="badge badge-soft-danger fs-xxs">Inactive</span></td>
                                                <td>
                                                    <div className="d-flex justify-content-center gap-1">
                                                        <a href="#" className="btn btn-default btn-icon btn-sm"><i className="ti ti-eye fs-lg"></i></a>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div className="d-flex align-items-center">
                                                        ...
                                                        <div>
                                                            <h5 className="mb-0">
                                                                <a data-sort="product" href="#!" className="link-reset">Kitchen Appliances</a>
                                                            </h5>
                                                        </div>
                                                    </div>
                                                </td>
                                                <td>appliances</td>
                                                <td>
                                                    <h5 className="fs-base mb-0 fw-medium">3021</h5>
                                                </td>
                                                <td>110.4k</td>
                                                <td>$12.1M</td>
                                                <td>30 Apr, 2025 <small className="text-muted">06:00 PM</small></td>
                                                <td><span className="badge badge-soft-success fs-xxs">Active</span></td>
                                                <td>
                                                    <div className="d-flex justify-content-center gap-1">
                                                        <a href="#" className="btn btn-default btn-icon btn-sm"><i className="ti ti-eye fs-lg"></i></a>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div className="d-flex align-items-center">
                                                        ...
                                                        <div>
                                                            <h5 className="mb-0">
                                                                <a data-sort="product" href="#!" className="link-reset">Smart Watches</a>
                                                            </h5>
                                                        </div>
                                                    </div>
                                                </td>
                                                <td>wearables</td>
                                                <td>
                                                    <h5 className="fs-base mb-0 fw-medium">6245</h5>
                                                </td>
                                                <td>95.3k</td>
                                                <td>$8.9M</td>
                                                <td>28 Apr, 2025 <small className="text-muted">10:45 AM</small></td>
                                                <td><span className="badge badge-soft-success fs-xxs">Active</span></td>
                                                <td>
                                                    <div className="d-flex justify-content-center gap-1">
                                                        <a href="#" className="btn btn-default btn-icon btn-sm"><i className="ti ti-eye fs-lg"></i></a>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div className="d-flex align-items-center">
                                                        ...
                                                        <div>
                                                            <h5 className="mb-0">
                                                                <a data-sort="product" href="#!" className="link-reset">Laptops</a>
                                                            </h5>
                                                        </div>
                                                    </div>
                                                </td>
                                                <td>electronics</td>
                                                <td>
                                                    <h5 className="fs-base mb-0 fw-medium">4890</h5>
                                                </td>
                                                <td>67.2k</td>
                                                <td>$15.4M</td>
                                                <td>29 Apr, 2025 <small className="text-muted">02:30 PM</small></td>
                                                <td><span className="badge badge-soft-danger fs-xxs">Inactive</span></td>
                                                <td>
                                                    <div className="d-flex justify-content-center gap-1">
                                                        <a href="#" className="btn btn-default btn-icon btn-sm"><i className="ti ti-eye fs-lg"></i></a>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div className="d-flex align-items-center">
                                                        ...
                                                        <div>
                                                            <h5 className="mb-0">
                                                                <a data-sort="product" href="#!" className="link-reset">Gaming Consoles</a>
                                                            </h5>
                                                        </div>
                                                    </div>
                                                </td>
                                                <td>gaming</td>
                                                <td>
                                                    <h5 className="fs-base mb-0 fw-medium">3756</h5>
                                                </td>
                                                <td>82.1k</td>
                                                <td>$10.7M</td>
                                                <td>27 Apr, 2025 <small className="text-muted">09:10 AM</small></td>
                                                <td><span className="badge badge-soft-success fs-xxs">Active</span></td>
                                                <td>
                                                    <div className="d-flex justify-content-center gap-1">
                                                        <a href="#" className="btn btn-default btn-icon btn-sm"><i className="ti ti-eye fs-lg"></i></a>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div className="d-flex align-items-center">
                                                        ...
                                                        <div>
                                                            <h5 className="mb-0">
                                                                <a data-sort="product" href="#!" className="link-reset">Bluetooth Speakers</a>
                                                            </h5>
                                                        </div>
                                                    </div>
                                                </td>
                                                <td>audio</td>
                                                <td>
                                                    <h5 className="fs-base mb-0 fw-medium">5432</h5>
                                                </td>
                                                <td>78.9k</td>
                                                <td>$6.3M</td>
                                                <td>26 Apr, 2025 <small className="text-muted">04:20 PM</small></td>
                                                <td><span className="badge badge-soft-success fs-xxs">Active</span></td>
                                                <td>
                                                    <div className="d-flex justify-content-center gap-1">
                                                        <a href="#" className="btn btn-default btn-icon btn-sm"><i className="ti ti-eye fs-lg"></i></a>
                                ...
                                <form id="addCategoryForm">
                                    <div className="modal-body">
                                        <div className="row g-3">
                                            ...
                                            <div className="col-md-6">
                                                <label for="categorySlug" className="form-label">Slug</label>
                                                <input type="text" className="form-control" id="categorySlug" placeholder="e.g. electronics" required />
                                            </div>
                                            ...
                                            <div className="col-md-6">
                                                <label for="categoryStatus" className="form-label">Status</label>
                                                <select id="categoryStatus" className="form-select" required>
                                            ...
                                            <div className="col-md-12">
                                                <label for="categoryDescription" className="form-label">Description (Optional)</label>
