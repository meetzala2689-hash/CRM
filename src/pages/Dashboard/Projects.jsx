                    ...
                    <ul className="sub-menu">
                      ...
                      <li className="side-nav-item">
                        <a href="dashboard-crm.html" className="side-nav-link">
                          <span className="menu-text" data-lang="dashboard-crm">
                            CRM
                          </span>
                        </a>
                      </li>
                    ...
                    <div className="row row-cols-xxl-5 row-cols-md-3 row-cols-1 g-0 text-center align-items-center">
                        ...
                        <div className="mt-3 mt-md-0 p-3">
                          ...
                          <p className="mb-0 text-muted">
                            <span className="text-danger me-2">
                              <i className="ti ti-chevron-down"></i> 9.19%
                            </span>
                      ...
                      <div className="col border-end border-light border-dashed">
                        <div className="mt-3 mt-md-0 p-3">
                          ...
                          <div className="d-flex align-items-center justify-content-center gap-2 my-3">
                            ...
                            <h3 className="mb-0 fw-bold">
                              <span data-target="9.6">0</span>k
                            </h3>
                          </div>
                          <p className="mb-0 text-muted">
                            <span className="text-success me-2">
                              <i className="ti ti-chevron-up"></i> 26.87%
                            </span>
                            <span className="text-nowrap">
                              Since last month
                            </span>
                      ...
                      <div className="col border-end border-light border-dashed">
                        <div className="mt-3 mt-md-0 p-3">
                          ...
                          <div className="d-flex align-items-center justify-content-center gap-2 my-3">
                            ...
                            <h3 className="mb-0 fw-bold">
                              $<span data-target="98.24">0</span>k
                            </h3>
                          </div>
                          <p className="mb-0 text-muted">
                            <span className="text-success me-2">
                              <i className="ti ti-chevron-up"></i> 3.51%
                            </span>
                            <span className="text-nowrap">
                              Since last month
                            </span>
                      ...
                      <div className="col border-end border-light border-dashed">
                        <div className="mt-3 mt-md-0 p-3">
                          ...
                          <p className="mb-0 text-muted">
                            <span className="text-danger me-2">
                              {" "}
                              <i className="ti ti-chevron-down"></i> 1.05%
                            </span>
                            <span className="text-nowrap">
                              Since last month
                            </span>
                      ...
                      <div className="col">
                        <div className="mt-3 mt-md-0 p-3">
                          ...
                          <button
                            type="button"
                            className="btn btn-sm btn-info time-tracker-btn fw-semibold w-100"
                          >
                            Start Tracker
                          </button>
                        </div>
                          ...
                          <ul className="dropdown-menu dropdown-menu-end">
                            <li>
                              <a className="dropdown-item" href="#">
                                {" "}
                                <i className="ti ti-eye me-2"></i> View All
                                Status Details{" "}
                              </a>
                            </li>
                            <li>
                            ...
                            <li>
                              <a className="dropdown-item" href="#">
                                {" "}
                                <i className="ti ti-calendar me-2"></i> Change
                                Date Range{" "}
                              </a>
                            </li>
                            <li>
                        ...
                        <div className="dropdown ms-auto">
                          ...
                          <ul className="dropdown-menu dropdown-menu-end">
                            <li>
                              <a className="dropdown-item" href="#">
                                {" "}
                                <i className="ti ti-chart-histogram me-2"></i>{" "}
                            ...
                            <li>
                              <a className="dropdown-item" href="#">
                                {" "}
                                <i className="ti ti-calendar me-2"></i> Select
                                Date Range{" "}
                              </a>
                            </li>
                            <li>
                      ...
                      <div className="card-body">
                        <div className="row text-center g-2">
                          ...
                          <div className="col">
                            <div className="border bg-light-subtle border-dashed border-light p-2 rounded">
                              <h4>
                                $<span data-target="982.5">0</span>k
                              </h4>
                          ...
                          <div className="col">
                            <div className="border bg-light-subtle border-dashed border-light p-2 rounded">
                              <h4>
                                ~<span data-target="12,559">0</span>h
                              </h4>
              ...
              <div className="col-xxl-3">
                <div className="card">
                  <div className="card-body">
                    <input
                      type="text"
                      className="form-control card-calendar-widget"
                    ...
                    <h4 className="card-title fs-sm my-3">
                      Today's Schedule:{" "}
                      <a href="#!" className="float-end fs-sm">
                        View All
                      </a>
                    </h4>
                    <ul className="list-unstyled mt-1 mb-0">
                        ...
                        <div className="d-flex gap-2 align-items-center">
                          ...
                          <div>
                            <p className="text-muted mb-1 fs-13">
                              <i className="ti ti-calendar"></i> 08:00 AM -
                              09:30 AM
                            </p>
                      ...
                      <li className="mb-3">
                        <div className="d-flex gap-2 align-items-center">
                          ...
                          <div>
                            <p className="text-muted mb-1 fs-13">
                              <i className="ti ti-calendar"></i> 10:00 AM -
                              11:15 AM
                            </p>
                      ...
                      <li>
                        <div className="d-flex gap-2 align-items-center">
                          ...
                          <div>
                            <p className="text-muted mb-1 fs-13">
                              <i className="ti ti-calendar"></i> 04:00 PM -
                              05:30 PM
                            </p>
                            <h5 className="m-0 fs-14">
            ...
            <div className="row">
              <div className="col-xxl-6">
                <div data-table data-table-rows-per-page="5" className="card">
                  ...
                  <div className="bg-light bg-opacity-25 p-2 text-center border-bottom border-dashed">
                    <p className="m-0">
                      <b>31</b> Active projects out of{" "}
                      <span className="fw-medium">958</span>
                    </p>
                  </div>
                      ...
                      <tbody>
                        <tr>
                          ...
                          <td>
                            ...
                            <h5 className="fs-base mb-0 fw-normal">
                              <i className="ti ti-circle fs-12 text-info"></i>{" "}
                              Early Stage
                            </h5>
                          </td>
                          <td style="width: 30px">
                        ...
                        <tr>
                          ...
                          <td>
                            <span className="text-muted fs-12">Status</span>
                            <h5 className="fs-base mb-0 fw-normal">
                              <i className="ti ti-circle fs-12 text-warning"></i>{" "}
                              In Progress
                            </h5>
                          </td>
                          <td style="width: 30px">
                        ...
                        <tr>
                          ...
                          <td>
                            <span className="text-muted fs-12">Status</span>
                            <h5 className="fs-base mb-0 fw-normal">
                              <i className="ti ti-circle fs-12 text-success"></i>{" "}
                              On Track
                            </h5>
                          </td>
                          <td style="width: 30px">
                        ...
                        <tr>
                          ...
                          <td>
                            <span className="text-muted fs-12">Status</span>
                            <h5 className="fs-base mb-0 fw-normal">
                              <i className="ti ti-circle fs-12 text-danger"></i>{" "}
                              Delayed
                            </h5>
                          </td>
                          <td style="width: 30px">
              ...
              <div className="col-xxl-6">
                <div data-table data-table-rows-per-page="5" className="card">
                  ...
                  <div className="bg-light bg-opacity-25 p-2 text-center border-bottom border-dashed">
                    <p className="m-0">
                      <b>107</b> Tasks completed out of{" "}
                      <span className="fw-medium">195</span>
                    </p>
                  </div>
